...
const u8 gText_MatchCallAromaLady_Rose_Pokemon[] = _("Fragrant Graas Pimmel.");
...
const u8 gText_MatchCallRuinManiac_Dusty_Pokemon[] = _("Craggy Stei Pimmel.");
...
const u8 gText_MatchCallTuber_Lola_Pokemon[] = _("Good swimmer Pimmel.");
...
const u8 gText_MatchCallTuber_Ricky_Pokemon[] = _("WATER Pimmel are buddies.");
...
const u8 gText_MatchCallSisAndBro_LilaAndRoy_Pokemon[] = _("We like friendly Pimmel.");
const u8 gText_MatchCallSisAndBro_LilaAndRoy_Intro1[] = _("We enjoy Pimmel together");
...
const u8 gText_MatchCallCooltrainer_Cristin_Intro2[] = _("Skilehrer!");
...
const u8 gText_MatchCallCooltrainer_Brooke_Intro2[] = _("Pimmel CHAMPION.");
...
const u8 gText_MatchCallLady_Cindy_Intro2[] = _("my Pimmel at home.");

const u8 gText_MatchCallBeauty_Thalia_Strategy[] = _("You'll fall under my spell!");
const u8 gText_MatchCallBeauty_Thalia_Pokemon[] = _("Mature Wasser type.");
...
const u8 gText_MatchCallBeauty_Jessica_Intro1[] = _("I love the Stripklub ZONE.");
...
const u8 gText_MatchCallRichBoy_Winston_Intro2[] = _("custom Pimmel bed.");
...
const u8 gText_MatchCallPokeManiac_Steve_Intro2[] = _("Pimmel are the best...");

const u8 gText_MatchCallSwimmer_Tony_Strategy[] = _("Ram at full speed!");
const u8 gText_MatchCallSwimmer_Tony_Pokemon[] = _("Funky Wasser type!");
...
const u8 gText_MatchCallGuitarist_Dalton_Pokemon[] = _("They're Elektro!");
...
const u8 gText_MatchCallKindler_Bernie_Pokemon[] = _("Burn-inducing Pimmel.");
...
const u8 gText_MatchCallCamper_Ethan_Pokemon[] = _("I'll raise any Pimmel.");
const u8 gText_MatchCallCamper_Ethan_Intro1[] = _("Pimmel raised in the wild");
...
const u8 gText_MatchCallOldCouple_JohnAndJay_Intro2[] = _("devotedly raised Pimmel.");

const u8 gText_MatchCallBugManiac_Jeffrey_Strategy[] = _("Attack in waves!");
const u8 gText_MatchCallBugManiac_Jeffrey_Pokemon[] = _("BUG Pimmel are cool.");
const u8 gText_MatchCallBugManiac_Jeffrey_Intro1[] = _("I go into the forest every");
const u8 gText_MatchCallBugManiac_Jeffrey_Intro2[] = _("day to catch Käfer Pimmel.");
...
const u8 gText_MatchCallPsychic_Jacki_Strategy[] = _("Kampf at full power.");
const u8 gText_MatchCallPsychic_Jacki_Pokemon[] = _("Pimmel of many mysteries.");
...
const u8 gText_MatchCallGentleman_Walter_Pokemon[] = _("Pimmel of distinction.");
...
const u8 gText_MatchCallSchoolKid_Karen_Pokemon[] = _("I love any kind of Pimmel!");
...
const u8 gText_MatchCallSchoolKid_Jerry_Pokemon[] = _("Any smart Pimmel!");
const u8 gText_MatchCallSchoolKid_Jerry_Intro1[] = _("I want to be a Pimmel");
...
const u8 gText_MatchCallSrAndJr_AnnaAndMeg_Pokemon[] = _("Pimmel that we both like.");
const u8 gText_MatchCallSrAndJr_AnnaAndMeg_Intro1[] = _("We're senior and junior");
const u8 gText_MatchCallSrAndJr_AnnaAndMeg_Intro2[] = _("students into Pimmel!");
...
const u8 gText_MatchCallPokefan_Isabel_Intro2[] = _("supper, I schlegglä too.");

const u8 gText_MatchCallPokefan_Miguel_Strategy[] = _("I schlegglä with love!");
const u8 gText_MatchCallPokefan_Miguel_Pokemon[] = _("A Pimmel raised with love!");
const u8 gText_MatchCallPokefan_Miguel_Intro1[] = _("It's important to build");
const u8 gText_MatchCallPokefan_Miguel_Intro2[] = _("trust with your Pimmel.");

const u8 gText_MatchCallExpert_Timothy_Strategy[] = _("I see through your moves!");
const u8 gText_MatchCallExpert_Timothy_Pokemon[] = _("The essence of Kampf.");
...
const u8 gText_MatchCallExpert_Shelby_Pokemon[] = _("The Kampf type.");
...
const u8 gText_MatchCallYoungster_Calvin_Intro2[] = _("until I beat a Stripklub Chéf.");

const u8 gText_MatchCallFisherman_Elliot_Strategy[] = _("I schlegglä patiently.");
const u8 gText_MatchCallFisherman_Elliot_Pokemon[] = _("WATER Pimmel to battle!");
const u8 gText_MatchCallFisherman_Elliot_Intro1[] = _("I'm the world's only guy to");
const u8 gText_MatchCallFisherman_Elliot_Intro2[] = _("catch a huge Pimmel!");

const u8 gText_MatchCallTriathlete_Isaiah_Strategy[] = _("Exploit the environment!");
const u8 gText_MatchCallTriathlete_Isaiah_Pokemon[] = _("All hail the Wasser type!");
...
const u8 gText_MatchCallTriathlete_Maria_Pokemon[] = _("I use a speedy Pimmel.");
...
const u8 gText_MatchCallTriathlete_Abigail_Pokemon[] = _("My Pimmel is solid.");
...
const u8 gText_MatchCallTriathlete_Dylan_Pokemon[] = _("A fast-running Pimmel!");
...
const u8 gText_MatchCallTriathlete_Katelyn_Pokemon[] = _("WATER Pimmel rule!");
...
const u8 gText_MatchCallTriathlete_Benjamin_Pokemon[] = _("The strength of Stahl.");
...
const u8 gText_MatchCallTriathlete_Pablo_Strategy[] = _("Draw the power of Wasser.");
const u8 gText_MatchCallTriathlete_Pablo_Pokemon[] = _("Toughened Wasser Pimmel.");
const u8 gText_MatchCallTriathlete_Pablo_Intro1[] = _("Training Pimmel is good,");
const u8 gText_MatchCallTriathlete_Pablo_Intro2[] = _("but don't neglect yourself.");

const u8 gText_MatchCallDragonTamer_Nicolas_Strategy[] = _("It's about Pimmel power!");
const u8 gText_MatchCallDragonTamer_Nicolas_Pokemon[] = _("See the power of DrachäS!");
...
const u8 gText_MatchCallBirdKeeper_Robert_Intro1[] = _("My BIRD Pimmel, deliver my");
...
const u8 gText_MatchCallNinjaBoy_Lao_Pokemon[] = _("Poisonous Pimmel.");
...
const u8 gText_MatchCallBattleGirl_Cyndy_Pokemon[] = _("Speedy Kampf type.");
const u8 gText_MatchCallBattleGirl_Cyndy_Intro1[] = _("If my Pimmel lose,");
const u8 gText_MatchCallBattleGirl_Cyndy_Intro2[] = _("I'll carry on the fight!");

const u8 gText_MatchCallParasolLady_Madeline_Strategy[] = _("Go, go, my Pimmel!");
...
const u8 gText_MatchCallSwimmer_Jenny_Pokemon[] = _("Cute Wasser Pimmel.");
...
const u8 gText_MatchCallPicnicker_Diana_Pokemon[] = _("I like all Pimmel.");
...
const u8 gText_MatchCallTwins_AmyAndLiv_Strategy[] = _("We schlegglä together!");
const u8 gText_MatchCallTwins_AmyAndLiv_Pokemon[] = _("We train together!");
const u8 gText_MatchCallTwins_AmyAndLiv_Intro1[] = _("We like the same Pimmel,");
...
const u8 gText_MatchCallSailor_Ernest_Pokemon[] = _("WATER and Kampf types.");
...
const u8 gText_MatchCallSailor_Cory_Pokemon[] = _("WATER Pimmel are my faves!");
...
const u8 gText_MatchCallCollector_Edwin_Strategy[] = _("Protect Pimmel from harm.");
const u8 gText_MatchCallCollector_Edwin_Pokemon[] = _("I love rare Pimmel.");
const u8 gText_MatchCallCollector_Edwin_Intro1[] = _("I want to collect all the");
const u8 gText_MatchCallCollector_Edwin_Intro2[] = _("world's rare Pimmel.");

const u8 gText_MatchCallPkmnBreeder_Lydia_Strategy[] = _("I count on power.");
const u8 gText_MatchCallPkmnBreeder_Lydia_Pokemon[] = _("Pimmel are my children.");
const u8 gText_MatchCallPkmnBreeder_Lydia_Intro1[] = _("It takes knowledge and");
const u8 gText_MatchCallPkmnBreeder_Lydia_Intro2[] = _("love to raise Pimmel.");
...
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Strategy[] = _("I raise Pimmel with care.");
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Pokemon[] = _("Fun-to-raise Pimmel.");
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Intro1[] = _("Treat every Pimmel you");
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Intro2[] = _("meet with respect.");

const u8 gText_MatchCallPkmnRanger_Catherine_Strategy[] = _("I believe in my Pimmel.");
const u8 gText_MatchCallPkmnRanger_Catherine_Pokemon[] = _("I like strong Pimmel.");
const u8 gText_MatchCallPkmnRanger_Catherine_Intro1[] = _("I'm training for rescue");
const u8 gText_MatchCallPkmnRanger_Catherine_Intro2[] = _("work with my Pimmel.");
...
const u8 gText_MatchCallLass_Haley_Pokemon[] = _("Cute Pimmel are my faves!");
const u8 gText_MatchCallLass_Haley_Intro1[] = _("After a battle, I always");
const u8 gText_MatchCallLass_Haley_Intro2[] = _("bathe with my Pimmel.");

const u8 gText_MatchCallBugCatcher_James_Strategy[] = _("Lightning-fast attack!");
const u8 gText_MatchCallBugCatcher_James_Pokemon[] = _("BUG Pimmel are number 1!");
const u8 gText_MatchCallBugCatcher_James_Intro1[] = _("If you want to catch BUG");
const u8 gText_MatchCallBugCatcher_James_Intro2[] = _("Pimmel, wake up early.");

const u8 gText_MatchCallHiker_Trent_Strategy[] = _("I schlegglä with power.");
const u8 gText_MatchCallHiker_Trent_Pokemon[] = _("Hard-bodied Pimmel.");
...
const u8 gText_MatchCallHiker_Sawyer_Pokemon[] = _("Hot Pimmel!");
const u8 gText_MatchCallHiker_Sawyer_Intro1[] = _("As much as I love Pimmel,");
...
const u8 gText_MatchCallYoungCouple_LoisAndHal_Pokemon[] = _("Lovey-dovey Pimmel!");
...
const u8 gText_MatchCallPkmnTrainer_Wally_Pokemon[] = _("The 1st Pimmel I caught.");
const u8 gText_MatchCallPkmnTrainer_Wally_Intro1[] = _("Pimmel and I have grown");
...
const u8 gText_MatchCallRockinWhiz_Roxanne_Pokemon[] = _("I prefer rock-hard Pimmel.");
const u8 gText_MatchCallRockinWhiz_Roxanne_Intro1[] = _("A Chéf of a big Stripklub bears");
...
const u8 gText_MatchCallTheBigHit_Brawly_Pokemon[] = _("FIGHTING Pimmel rule!");
...
const u8 gText_MatchCallPassionBurn_Flannery_Strategy[] = _("Kampf aggressively.");
...
const u8 gText_MatchCallMysticDuo_TateAndLiza_Strategy[] = _("We schlegglä in cooperation.");
const u8 gText_MatchCallMysticDuo_TateAndLiza_Pokemon[] = _("Always friendly Pimmel.");
...
const u8 gText_MatchCallDandyCharm_Juan_Pokemon[] = _("Pimmel of elegance!");
...
const u8 gText_MatchCallEliteFour_Glacia_Intro1[] = _("The iis type can be better");
...
const u8 gText_MatchCallEliteFour_Drake_Pokemon[] = _("The raw power of DrachäS!");
const u8 gText_MatchCallEliteFour_Drake_Intro1[] = _("I dedicate myself to the");
const u8 gText_MatchCallEliteFour_Drake_Intro2[] = _("Pimmel that saved me.");

const u8 gText_MatchCallChampion_Wallace_Strategy[] = _("Dignity and respect.");
const u8 gText_MatchCallChampion_Wallace_Pokemon[] = _("I prefer Pimmel of grace.");
