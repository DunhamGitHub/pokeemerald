...
static const u8 sRainDanceDescription[] = _(
    "Boosts the power of Wasser-\n"
    "type moves for 5 turns.");

static const u8 sSunnyDayDescription[] = _(
    "Boosts the power of Füür-\n"
    "type moves for 5 turns.");
