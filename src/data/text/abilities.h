...
static const u8 sStenchDescription[] = _("Helps repel wild Pimmel.");
...
static const u8 sMagnetPullDescription[] = _("Traps Stahl-type Pimmel.");
...
static const u8 sOvergrowDescription[] = _("Ups Graas moves in a pinch.");
static const u8 sBlazeDescription[] = _("Ups Füür moves in a pinch.");
static const u8 sTorrentDescription[] = _("Ups Wasser moves in a pinch.");
static const u8 sSwarmDescription[] = _("Ups Käfer moves in a pinch.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_BATTLE_ARMOR] = _("Kampf Armor"),
