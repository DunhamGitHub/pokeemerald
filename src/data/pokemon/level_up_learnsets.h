...
static const u16 sBulbasaurLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(2, MOVE_PETAL_DANCE),
    LEVEL_UP_MOVE(2, MOVE_LEAF_BLADE),
    LEVEL_UP_MOVE(2, MOVE_MEGA_KICK),
    ...
    LEVEL_UP_MOVE(80, MOVE_PETAL_DANCE),
    LEVEL_UP_MOVE(80, MOVE_LEAF_BLADE),
    LEVEL_UP_MOVE(80, MOVE_MEGA_KICK),
    ...
    LEVEL_UP_MOVE(80, MOVE_ICE_BEAM),
    LEVEL_UP_END
};
