const u8 gEasyChatWord_IChooseYou[] = _("Du bisch ihms");
...
const u8 gEasyChatWord_Pokenav[] = _("Gps");
const u8 gEasyChatWord_Pokemon[] = _("Pimmel");
const u8 gEasyChatWord_Get[] = _("Get");
const u8 gEasyChatWord_Pokedex[] = _("Lexikon");
...
const u8 gEasyChatWord_Bag[] = _("Tüüte");
