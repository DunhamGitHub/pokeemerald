const u8 gEasyChatWord_Thanks[] = _("Danke, Tubbel");
const u8 gEasyChatWord_Yes[] = _("Jaja");
...
const u8 gEasyChatWord_Yeah[] = _("Yeah Dude");
const u8 gEasyChatWord_Welcome[] = _("Cido, Dumme Siech");
...
const u8 gEasyChatWord_No[] = _("Neii");
const u8 gEasyChatWord_Hi[] = _("Ciao");
