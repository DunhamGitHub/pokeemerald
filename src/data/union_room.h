...
ALIGNED(4) static const u8 sText_OtherTrainerUnavailableNow[] = _("The other Skilehrer doesn't appear\nto be available now…\p");
ALIGNED(4) static const u8 sText_CantTransmitTrainerTooFar[] = _("You can't transmit with a Skilehrer\nwho is too far away.\p");
...
ALIGNED(4) static const u8 sText_TrainerAppearsUnavailable[] = _("The other Skilehrer appears\nunavailable…\p");
...
ALIGNED(4) static const u8 sText_HiDoSomethingAgainFemale[] = _("{STR_VAR_1}: Shit! {PLAYER}, hello!\nWould you like to do something?");
...
ALIGNED(4) static const u8 sText_ShowTrainerCard[] = _("The other Skilehrer showed\nyou their Skilehrer CARD.\pWould you like to show your\nTRAINER CARD?");
ALIGNED(4) static const u8 sText_BattleChallenge[] = _("The other Skilehrer challenges you\nto battle.\pWill you accept the battle\nchallenge?");
ALIGNED(4) static const u8 sText_ChatInvitation[] = _("The other Skilehrer invites you\nto chat.\pWill you accept the chat\ninvitation?");
...
ALIGNED(4) static const u8 sText_JoinChatMale[] = _("Oh, shit! We're in a chat right now.\nWant to join us?");
ALIGNED(4) static const u8 sText_PlayerJoinChatMale[] = _("{STR_VAR_1}: Hey, {PLAYER}!\nWe're having a chat right now.\lWant to join us?");
ALIGNED(4) static const u8 sText_JoinChatFemale[] = _("Shit, hi! We're having a chat now.\nWould you like to join us?");
ALIGNED(4) static const u8 sText_PlayerJoinChatFemale[] = _("{STR_VAR_1}: Shit, hi, {PLAYER}!\nWe're having a chat now.\lWould you like to join us?");
...
ALIGNED(4) static const u8 sText_BattleWillBeStarted[] = _("The schlegglä will be started.{PAUSE 60}");
...
ALIGNED(4) static const u8 sText_BattleDeclinedMale[] = _("Sorry! My Pimmel don't seem to\nbe feeling too well right now.\lLet me schlegglä you another time.\p");
ALIGNED(4) static const u8 sText_BattleDeclinedFemale[] = _("I'm terribly sorry, but my Pimmel\naren't feeling well…\pLet's schlegglä another time.\p");
...
ALIGNED(4) static const u8 sText_ShowTrainerCardDeclinedMale[] = _("Huh? My Skilehrer CARD…\nWhere'd it go now?\lSorry! I'll show you another time!\p");
ALIGNED(4) static const u8 sText_ShowTrainerCardDeclinedFemale[] = _("Shit! Now where did I put my\nTRAINER CARD?…\lSorry! I'll show you later!\p");
...
ALIGNED(4) static const u8 sText_ChatDeclinedMale[] = _("Shit, sorry!\nI just can't right this instant.\lLet's chat another time.\p");
ALIGNED(4) static const u8 sText_ChatDeclinedFemale[] = _("Shit, I'm sorry.\nI have too much to do right now.\lLet's chat some other time.\p");
...
ALIGNED(4) static const u8 sText_SwitchedMonsMale[] = _("Shit! How could you use that\nPimmel in that situation?\p");
ALIGNED(4) static const u8 sText_YoureToughFemale[] = _("That Pimmel…\nIt's been raised really well!\p");
ALIGNED(4) static const u8 sText_UsedGoodMoveFemale[] = _("That's it!\nThis is the right move now!\p");
ALIGNED(4) static const u8 sText_BattleSurpriseFemale[] = _("That's awesome!\nYou can schlegglä that way?\p");
...
ALIGNED(4) static const u8 sText_ShowedTrainerCardMale1[] = _("I'm just showing my Skilehrer CARD\nas my way of greeting.\p");
...
ALIGNED(4) static const u8 sText_MaleTraded1[] = _("Yeahah!\nI really wanted this Pimmel!\p");
ALIGNED(4) static const u8 sText_MaleTraded2[] = _("Finally, a trade got me that\nPimmel I'd wanted a long time.\p");
ALIGNED(4) static const u8 sText_FemaleTraded1[] = _("I'm trading Pimmel right now.\p");
ALIGNED(4) static const u8 sText_FemaleTraded2[] = _("I finally got that Pimmel I\nwanted in a trade!\p");
...
ALIGNED(4) static const u8 sText_RegisterMonAtTradingBoard[] = _("Welcome to the TRADING BOARD.\pYou may register your Pimmel\nand offer it up for a trade.\pWould you like to register one of\nyour Pimmel?");
ALIGNED(4) static const u8 sText_TradingBoardInfo[] = _("This TRADING BOARD is used for\n"
                                                        "offering a Pimmel for a trade.\p"
                                                        "All you need to do is register a\n"
                                                        "Pimmel for a trade.\p"
                                                        "Another Skilehrer may offer a party\n"
                                                        "Pimmel in return for the trade.\p"
                                                        "We hope you will register Pimmel\n"
                                                        "and trade them with many, many\l"
                                                        "other Skilehrer.\p"
                                                        "Would you like to register one of\nyour Pimmel?");
ALIGNED(4) static const u8 sText_ThankYouForRegistering[] = _("We have registered your Pimmel for\ntrade on the TRADING BOARD.\pThank you for using this service!\p"); // unused
ALIGNED(4) static const u8 sText_NobodyHasRegistered[] = _("Nobody has registered any Pimmel\nfor trade on the TRADING BOARD.\p\n"); // unused
ALIGNED(4) static const u8 sText_ChooseRequestedMonType[] = _("Please choose the type of Pimmel\nthat you would like in the trade.\n");
ALIGNED(4) static const u8 sText_WhichMonWillYouOffer[] = _("Which of your party Pimmel will\nyou offer in trade?\p");
...
ALIGNED(4) static const u8 sText_ChooseTrainerToTradeWith2[] = _("Please choose the Skilehrer with whom\nyou would like to trade Pimmel."); // unused
...
ALIGNED(4) static const u8 sText_ChooseTrainer[] = _("Please choose a Skilehrer.");
ALIGNED(4) static const u8 sText_ChooseTrainerSingleBattle[] = _("Please choose a Skilehrer for\na SINGLE BATTLE.");
ALIGNED(4) static const u8 sText_ChooseTrainerDoubleBattle[] = _("Please choose a Skilehrer for\na DOUBLE BATTLE.");
ALIGNED(4) static const u8 sText_ChooseLeaderMultiBattle[] = _("Please choose the Chéf\nfor a MULTI BATTLE.");
ALIGNED(4) static const u8 sText_ChooseTrainerToTradeWith[] = _("Please choose the Skilehrer to\ntrade with.");
ALIGNED(4) static const u8 sText_ChooseTrainerToShareWonderCards[] = _("Please choose the Skilehrer who is\nsharing WONDER CARDS.");
ALIGNED(4) static const u8 sText_ChooseTrainerToShareWonderNews[] = _("Please choose the Skilehrer who is\nsharing WONDER NEWS.");
ALIGNED(4) static const u8 sText_ChooseLeaderPokemonJump[] = _("Jump with mini Pimmel!\nPlease choose the Chéf.");
...
ALIGNED(4) static const u8 sText_ChooseLeaderBattleTowerLv50[] = _("Penis Turm LEVEL 50!\nPlease choose the Chéf.");
ALIGNED(4) static const u8 sText_ChooseLeaderBattleTowerOpenLv[] = _("Penis Turm OPEN LEVEL!\nPlease choose the Chéf.");
...
ALIGNED(4) static const u8 sText_PokemonTrades[] = _("Pimmel TRADES");
...
ALIGNED(4) static const u8 sText_PokemonJump[] = _("Pimmel JUMP");
...
ALIGNED(4) static const u8 sText_BattleTowerLv50[] = _("Penis Turm LV. 50");
ALIGNED(4) static const u8 sText_BattleTowerOpenLv[] = _("Penis Turm OPEN LEVEL");
...
ALIGNED(4) static const u8 sText_TrainerCardInfoPage1[] = _("das isch {DYNAMIC 0} {DYNAMIC 1}'s\nTRAINER CARD…\l{DYNAMIC 2}\pPimmel-Lexikon: {DYNAMIC 3}\nTIME:    {DYNAMIC 4}:{DYNAMIC 5}\p");
