...
const u8 gText_ThisIsAPokemon[] = _("Das Kakkteil heisst “Penner.”{PAUSE 96}"); // \p"); was here
...
const u8 gText_HOFDexRating[] = _("Spotted Pimmel: {STR_VAR_1}!\nOwned Pimmel: {STR_VAR_2}!\pDr. Pimmel's Pimmel-Lexikon rating!\pDr. Pimmel: Let's see…"); // \p"); was here
...
const u8 gText_DadsAdvice[] = _("Papi's advice…\n{PLAYER}, there's a time and place for\leverything!"); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_CantDismountBike[] = _("You can't dismount your Vélo here."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_ItemFinderNearby[] = _("Huh?\nThe ITEMFINDER's responding!\pThere's an item buried around here!"); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_ItemFinderOnTop[] = _("Shit!\nThe ITEMFINDER's shaking wildly!"); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_ItemFinderNothing[] = _("… … … …Nope!\nThere's no response."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_CoinCase[] = _("Your COINS:\n{STR_VAR_1}"); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_PlayerUsedVar2[] = _("{PLAYER} used the\n{STR_VAR_2}."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_RepelEffectsLingered[] = _("Aber the effects of a REPEL\nlingered from earlier."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild Pimmel will be lured."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild Pimmel will be repelled."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_BoxFull[] = _("The BOX is full."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PowderQty[] = _("POWDER QTY: {STR_VAR_1}"); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_YouDontHaveMoney[] = _("Du bisch zu Pleite, Penner!."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_NoMoreRoomForThis[] = _("Kei Platz meh für das Zeug."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_SpaceForVar1Full[] = _("Kei Platz meh für {STR_VAR_1}."); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_ThrowInPremierBall[] = _("Ich gib der gratis än PREMIER BALL."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_CantBuyKeyItem[] = _("{STR_VAR_2}? Shit, no.\nI can't buy that."); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_MoveNotLearned[] = _("{STR_VAR_1} did not learn the\nmove {STR_VAR_2}."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_WhichMoveToForget[] = _("Which move should be forgotten?"); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_12PoofForgotMove[] = _("1, {PAUSE 15}2, and{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p{STR_VAR_1} forgot how to\nuse {STR_VAR_2}.\pAnd…"); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnAlreadyKnows[] = _("{STR_VAR_1} already knows\n{STR_VAR_2}."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnHPRestoredByVar2[] = _("{STR_VAR_1}'s HP was restored\nby {STR_VAR_2} point(s)."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnCuredOfPoison[] = _("{STR_VAR_1} was cured of its\npoisoning."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnCuredOfParalysis[] = _("{STR_VAR_1} was cured of\nparalysis."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnWokeUp2[] = _("{STR_VAR_1} woke up."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnBurnHealed[] = _("{STR_VAR_1}'s burn was healed."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnThawedOut[] = _("{STR_VAR_1} was thawed out."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PPWasRestored[] = _("PP was restored."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnRegainhedHealth[] = _("{STR_VAR_1} regained health."); // {PAUSE_UNTIL_PRESS}"); was here // Unused
const u8 gText_PkmnBecameHealthy[] = _("{STR_VAR_1} became healthy."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_MovesPPIncreased[] = _("{STR_VAR_1}'s PP increased."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnElevatedToLvVar2[] = _("{STR_VAR_1} was elevated to\nLv. {STR_VAR_2}.");
const u8 gText_PkmnBaseVar2StatIncreased[] = _("{STR_VAR_1}'s base {STR_VAR_2}\nstat was raised."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnFriendlyBaseVar2Fell[] = _("{STR_VAR_1} turned friendly.\nThe base {STR_VAR_2} fell!"); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnAdoresBaseVar2Fell[] = _("{STR_VAR_1} adores you!\nThe base {STR_VAR_2} fell!"); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnFriendlyBaseVar2CantFall[] = _("{STR_VAR_1} turned friendly.\nThe base {STR_VAR_2} can't fall!"); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnSnappedOutOfConfusion[] = _("{STR_VAR_1} snapped out of its\nconfusion."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_PkmnGotOverInfatuation[] = _("{STR_VAR_1} got over its\ninfatuation."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_ThrowAwayItem[] = _("Throw away this\n{STR_VAR_1}?");
const u8 gText_ItemThrownAway[] = _("The {STR_VAR_1}\nwas thrown away."); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_PkmnCantParticipate[] = _("That Pimmel can't participate."); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_PauseUntilPress[] = _(""); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_RegisteredDataDeleted[] = _("The registered data was deleted."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_NoRegistry[] = _("There is no REGISTRY."); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_NoDecorations[] = _("There are no decorations."); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_NoDecorationsInUse[] = _("There are no decorations in use."); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_NoItems[] = _("There are no items."); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_NoMailHere[] = _("There's no MAIL here."); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_BagIsFull[] = _("The Tüüte is full."); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_MailToBagMessageErased[] = _("The MAIL was returned to the Tüüte\nwith its message erased."); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_MatchCallSteven_Pokemon[] = _("Ultimate Stahl Pimmel.");
...
const u8 gText_PokemonOnHook[] = _("A Pimmel's on the hook!"); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_NotEvenANibble[] = _("Not even a nibble…"); // {PAUSE_UNTIL_PRESS}"); was here
const u8 gText_ItGotAway[] = _("It got away…"); // {PAUSE_UNTIL_PRESS}"); was here
...
const u8 gText_MoveRelearnerAndPoof[] = _("{PAUSE 32}1, {PAUSE 15}2, and {PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Poof!"); // \p"); was here
...
const u8 gText_StevenMatchCallDesc[] = _("Hard As Penis");
