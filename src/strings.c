...
const u8 gText_ExpandedPlaceholder_Aqua[] = _("Schwul");
const u8 gText_ExpandedPlaceholder_Magma[] = _("Gay");
const u8 gText_ExpandedPlaceholder_Archie[] = _("Pfoschti");
const u8 gText_ExpandedPlaceholder_Maxie[] = _("Kakki");
const u8 gText_ExpandedPlaceholder_Kyogre[] = _("Affegsicht");
const u8 gText_ExpandedPlaceholder_Groudon[] = _("Penis");
const u8 gText_ExpandedPlaceholder_Brendan[] = _("Kakbohne");
const u8 gText_ExpandedPlaceholder_May[] = _("Mai");
const u8 gText_EggNickname[] = _("Eii");
const u8 gText_Pokemon[] = _("Pimmel");
const u8 gText_ProfBirchMatchCallName[] = _("Dr. Pimmel");
const u8 gText_MainMenuNewGame[] = _("Neis Spiel");
const u8 gText_MainMenuContinue[] = _("Wiiterkakke");
const u8 gText_MainMenuOption[] = _("Optionä");
...
const u8 gText_SaveFileCorrupted[] = _("S'Save-File isch wieder am Arsch!\nMir nämed s'Letscht halt...");
...
const u8 gText_Player[] = _("Penner"); // Unused
const u8 gText_Pokedex[] = _("Pimmel-Lexikon"); // Unused
const u8 gText_Time[] = _("Ziit");
const u8 gText_Badges[] = _("Medaliä"); // Unused
const u8 gText_AButton[] = _("A Knopf"); // Unused
const u8 gText_BButton[] = _("B Knopf"); // Unused
const u8 gText_RButton[] = _("R Knopf"); // Unused
const u8 gText_LButton[] = _("L Knopf"); // Unused
...
const u8 gText_BirchBoy[] = _("Goof");
const u8 gText_BirchGirl[] = _("Chic");
const u8 gText_DefaultNameStu[] = _("Schwulian");
const u8 gText_DefaultNameMilton[] = _("Kakknase");
const u8 gText_DefaultNameTom[] = _("Oberpfoschte");
const u8 gText_DefaultNameKenny[] = _("Aff");
const u8 gText_DefaultNameReid[] = _("Dummschwätzer");
const u8 gText_DefaultNameJude[] = _("Ueli");
const u8 gText_DefaultNameJaxson[] = _("Ueli");
const u8 gText_DefaultNameEaston[] = _("Ueli");
const u8 gText_DefaultNameWalker[] = _("Ueli");
const u8 gText_DefaultNameTeru[] = _("Ueli");
const u8 gText_DefaultNameJohnny[] = _("Ueli");
const u8 gText_DefaultNameBrett[] = _("Ueli");
const u8 gText_DefaultNameSeth[] = _("Ueli");
const u8 gText_DefaultNameTerry[] = _("Penner");
const u8 gText_DefaultNameCasey[] = _("Penner");
const u8 gText_DefaultNameDarren[] = _("Penner");
const u8 gText_DefaultNameLandon[] = _("Penner");
const u8 gText_DefaultNameCollin[] = _("Penner");
const u8 gText_DefaultNameStanley[] = _("Penner");
const u8 gText_DefaultNameQuincy[] = _("Penner");
const u8 gText_DefaultNameKimmy[] = _("Penner");
const u8 gText_DefaultNameTiara[] = _("Penner");
const u8 gText_DefaultNameBella[] = _("Penner");
const u8 gText_DefaultNameJayla[] = _("Penner");
const u8 gText_DefaultNameAllie[] = _("Penner");
const u8 gText_DefaultNameLianna[] = _("Penner");
const u8 gText_DefaultNameSara[] = _("Penner");
const u8 gText_DefaultNameMonica[] = _("Penner");
const u8 gText_DefaultNameCamila[] = _("Penner");
const u8 gText_DefaultNameAubree[] = _("Penner");
const u8 gText_DefaultNameRuthie[] = _("Penner");
const u8 gText_DefaultNameHazel[] = _("Penner");
const u8 gText_DefaultNameNadine[] = _("Penner");
const u8 gText_DefaultNameTanja[] = _("Penner");
const u8 gText_DefaultNameYasmin[] = _("Penner");
const u8 gText_DefaultNameNicola[] = _("Penner");
const u8 gText_DefaultNameLillie[] = _("Penner");
const u8 gText_DefaultNameTerra[] = _("Penner");
const u8 gText_DefaultNameLucy[] = _("Penner");
const u8 gText_DefaultNameHalie[] = _("Penner");
const u8 gText_ThisIsAPokemon[] = _("Das Kakkteil heisst “Penner”.\p");
const u8 gText_5MarksPokemon[] = _("????? Pimmel");
const u8 gText_UnkHeight[] = _("{CLEAR_TO 0x0C}??'??”");
const u8 gText_UnkWeight[] = _("????.? fett.");
const u8 gText_EmptyPkmnCategory[] = _("                       Pimmel"); // Unused
const u8 gText_EmptyHeight[] = _("{CLEAR_TO 0x0C}    '    ”"); // Unused
const u8 gText_EmptyWeight[] = _("        .   fett."); // Unused
...
const u8 gText_PokedexRegistration[] = _("Pimmel-Lexikon registration completed.");
...
const u8 gText_NoMatchingPkmnWereFound[] = _("No matching Pimmel were found.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Search for Pimmel based on\nselected parameters.");
const u8 gText_SwitchPokedexListings[] = _("Switch Pimmel-Lexikon listings.");
const u8 gText_ReturnToPokedex[] = _("Return to the Pimmel-Lexikon.");
const u8 gText_SelectPokedexMode[] = _("Select the Pimmel-Lexikon mode.");
const u8 gText_SelectPokedexListingMode[] = _("Select the Pimmel-Lexikon listing mode.");
...
const u8 gText_DexHoennTitle[] = _("Hoenn Lexikon");
const u8 gText_DexNatTitle[] = _("National Lexikon");
...
const u8 gText_DexHoennDescription[] = _("Hoenn region's Pimmel-Lexikon");
const u8 gText_DexNatDescription[] = _("National edition Pimmel-Lexikon");
const u8 gText_DexSortNumericalDescription[] = _("Pimmel are listed according to their\nnumber.");
const u8 gText_DexSortAtoZDescription[] = _("Spotted and owned Pimmel are listed\nalphabetically.");
const u8 gText_DexSortHeaviestDescription[] = _("Owned Pimmel are listed from the\nheaviest to the lightest.");
const u8 gText_DexSortLightestDescription[] = _("Owned Pimmel are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortTallestDescription[] = _("Owned Pimmel are listed from the\ntallest to the smallest.");
const u8 gText_DexSortSmallestDescription[] = _("Owned Pimmel are listed from the\nsmallest to the tallest.");
const u8 gText_DexEmptyString[] = _("");const u8 gText_DexSearchDontSpecify[] = _("Don't Specify.");
const u8 gText_DexSearchTypeNone[] = _("None");
const u8 gText_SelectorArrow[] = _("▶");
const u8 gText_EmptySpace[] = _(" "); // Unused
const u8 gText_WelcomeToHOF[] = _("Welcome to the Pimmelturm!");
const u8 gText_HOFDexRating[] = _("Spotted Pimmel: {STR_VAR_1}!\nOwned Pimmel: {STR_VAR_2}!\pDr. Pimmel's Pimmel-Lexikon rating!\pDr. Pimmel: Let's see…\p");
const u8 gText_HOFDexSaving[] = _("Speichere…\nChills mal...");
const u8 gText_HOFCorrupted[] = _("The Pimmelturm data is corrupted.");
const u8 gText_HOFNumber[] = _("Pimmelturm No. {STR_VAR_1}");
const u8 gText_LeagueChamp[] = _("LEAGUE CHAMPION!\nCONGRATULATIONS!");
const u8 gText_Number[] = _("No. ");
const u8 gText_Level[] = _("Level ");
const u8 gText_IdNumberSlash[] = _("IDNo. /"); // Unused
const u8 gText_Name[] = _("Name");
const u8 gText_IDNumber[] = _("IDNo.");
const u8 gText_BirchInTrouble[] = _("Dr. Pimmel is in trouble!\nRelease a Pimmel and rescue him!");
const u8 gText_ConfirmStarterChoice[] = _("Do you choose this Pimmel?");
const u8 gText_Pokemon4[] = _("Pimmel"); // Unused
const u8 gText_FlyToWhere[] = _("Flüüge wo? …Tubbel");
...
const u8 gText_Berry2[] = _(" Beeri"); // Unused
const u8 gText_Coins[] = _("{STR_VAR_1} Kohle");
const u8 gText_CloseBag[] = _("Close Tüüte");
...
const u8 gText_DadsAdvice[] = _("Papi's advice…\n{PLAYER}, there's a time and place for\leverything!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_CantDismountBike[] = _("You can't dismount your Vélo here.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_ItemFinderNearby[] = _("Huh?\nThe ITEMFINDER's responding!\pThere's an item buried around here!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_ItemFinderOnTop[] = _("Shit!\nThe ITEMFINDER's shaking wildly!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_ItemFinderNothing[] = _("… … … …Nope!\nThere's no response.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_CoinCase[] = _("Your COINS:\n{STR_VAR_1}{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_BootedUpTM[] = _("Zieht sich TM voll ine.");
const u8 gText_BootedUpHM[] = _("Zieht sich HM voll Röhre.");
const u8 gText_TMHMContainedVar1[] = _("It contained\n{STR_VAR_1}.\pTeach {STR_VAR_1}\nto a Pimmel?");
const u8 gText_PlayerUsedVar2[] = _("{PLAYER} used the\n{STR_VAR_2}.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_RepelEffectsLingered[] = _("Aber the effects of a REPEL\nlingered from earlier.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild Pimmel will be lured.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild Pimmel will be repelled.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_BoxFull[] = _("The BOX is full.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PowderQty[] = _("POWDER QTY: {STR_VAR_1}{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_TheField[] = _("the field");
const u8 gText_TheBattle[] = _("Schlegglä");
const u8 gText_ThePokemonList[] = _("the Pimmel LIST");
const u8 gText_TheShop[] = _("the shop");
const u8 gText_ThePC[] = _("the MAC");
...
const u8 gText_ItemsPocket[] = _("Zeugs");
const u8 gText_PokeBallsPocket[] = _("Kakk-Eier");
const u8 gText_TMHMPocket[] = _("Tm & Hm");
const u8 gText_BerriesPocket[] = _("Beeri");
const u8 gText_KeyItemsPocket[] = _("Key Zeugs");
...
const u8 gText_BerryTag[] = _("Beeri Tag");
...
const u8 gText_ShopBuy[] = _("Kauf");
const u8 gText_ShopSell[] = _("Verkauf");
const u8 gText_ShopQuit[] = _("Verpisse...");
const u8 gText_InBagVar1[] = _("In Tüüte: {STR_VAR_1}");
const u8 gText_QuitShopping[] = _("Quit shopping.");
const u8 gText_Var1CertainlyHowMany[] = _("{STR_VAR_1}? denn halt.\nWie viel devo?");
const u8 gText_Var1CertainlyHowMany2[] = _("{STR_VAR_1}? denn halt.\nWie viel devo?");
const u8 gText_Var1AndYouWantedVar2[] = _("{STR_VAR_1}? Und wotsch {STR_VAR_2}?\nGib de Köhls ¥{STR_VAR_3}.");
const u8 gText_Var1IsItThatllBeVar2[] = _("{STR_VAR_1}, denn halt?\nGib Köhls ¥{STR_VAR_2} oder git eis id Frässi?");
const u8 gText_YouWantedVar1ThatllBeVar2[] = _("Wotsch ihms {STR_VAR_1}?\nGib Kohle ¥{STR_VAR_2} oder git eis id Frässi!");
const u8 gText_HereYouGoThankYou[] = _("Hans scho denkt, Penner!\nVerpiss dich jetzt.");
const u8 gText_ThankYouIllSendItHome[] = _("Oké!\nIch schicks hei (zum MAC).");
const u8 gText_ThanksIllSendItHome[] = _("Oké!\nIch schicks hei (zum MAC).");
const u8 gText_YouDontHaveMoney[] = _("Du bisch zu Pleite, Penner!.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreRoomForThis[] = _("Kei Platz meh für das Zeug.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_SpaceForVar1Full[] = _("Kei Platz meh für {STR_VAR_1}.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_AnythingElseICanHelp[] = _("..suscht no was? Du Penner!?");
const u8 gText_CanIHelpWithAnythingElse[] = _("..suscht no was? Du Penner!?");
const u8 gText_ThrowInPremierBall[] = _("Ich gib der gratis än PREMIER BALL.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_CantBuyKeyItem[] = _("{STR_VAR_2}? Shit, no.\nI can't buy that.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_HowManyToSell[] = _("{STR_VAR_2}?\nAaach!, oké wie viel wotsch verkaufe?");
const u8 gText_ICanPayVar1[] = _("¥{STR_VAR_1} und gratis eis id Frässi.\nDeal?");
const u8 gText_TurnedOverVar1ForVar2[] = _("Hät {STR_VAR_2} gäh\nund bechunt ¥{STR_VAR_1}.");
const u8 gText_PokedollarVar1[] = _("¥{STR_VAR_1}");
const u8 gText_Shift[] = _("Shift");
const u8 gText_SendOut[] = _("Useschicke");
const u8 gText_Switch2[] = _("Switch");
const u8 gText_Summary5[] = _("Übersicht");
...
const u8 gText_WontHaveEffect[] = _("It won't have any effect.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_CantBeUsedOnPkmn[] = _("This can't be used on\nthat Pimmel.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnCantSwitchOut[] = _("{STR_VAR_1} can't be switched\nout!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAlreadyInBattle[] = _("{STR_VAR_1} is already\nin battle!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAlreadySelected[] = _("{STR_VAR_1} has already been\nselected.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnHasNoEnergy[] = _("{STR_VAR_1} has no energy\nleft to battle!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_CantSwitchWithAlly[] = _("You can't switch {STR_VAR_1}'s\nPimmel with one of yours!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_EggCantBattle[] = _("An Ei can't battle!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_CantUseUntilNewBadge[] = _("This can't be used until a new\nBADGE is obtained.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {STR_VAR_1} Pimmel\nmay enter.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_SendMailToPC[] = _("Send the removed MAIL to\nyour MAC?");
const u8 gText_MailSentToPC[] = _("The MAIL was sent to your MAC.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PCMailboxFull[] = _("Your MAC's MAILBOX is full.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_MailMessageWillBeLost[] = _("If the MAIL is removed, the\nmessage will be lost. Okay?");
const u8 gText_RemoveMailBeforeItem[] = _("MAIL must be removed before\nholding an item.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnWasGivenItem[] = _("{STR_VAR_1} was given the\n{STR_VAR_2} to hold.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAlreadyHoldingItemSwitch[] = _("{STR_VAR_1} is already holding\none {STR_VAR_2}.\pWould you like to switch the\ntwo items?");
const u8 gText_PkmnNotHolding[] = _("{STR_VAR_1} isn't holding\nanything.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_ReceivedItemFromPkmn[] = _("Received the {STR_VAR_2}\nfrom {STR_VAR_1}.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_MailTakenFromPkmn[] = _("MAIL was taken from the\nPimmel.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_SwitchedPkmnItem[] = _("The {STR_VAR_2} was taken and\nreplaced with the {STR_VAR_1}.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnHoldingItemCantHoldMail[] = _("This Pimmel is holding an\nitem. It cannot hold MAIL.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_MailTransferredFromMailbox[] = _("MAIL was transferred from\nthe MAILBOX.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_BagFullCouldNotRemoveItem[] = _("The Tüüte is full. The Pimmel's\nitem could not be removed.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnLearnedMove3[] = _("{STR_VAR_1} learned\n{STR_VAR_2}!");
const u8 gText_PkmnCantLearnMove[] = _("{STR_VAR_1} and {STR_VAR_2}\nare not compatible.\p{STR_VAR_2} can't be\nlearned.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_MoveNotLearned[] = _("{STR_VAR_1} did not learn the\nmove {STR_VAR_2}.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_WhichMoveToForget[] = _("Which move should be forgotten?{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_12PoofForgotMove[] = _("1, {PAUSE 15}2, and{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p{STR_VAR_1} forgot how to\nuse {STR_VAR_2}.\pAnd…{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAlreadyKnows[] = _("{STR_VAR_1} already knows\n{STR_VAR_2}.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnHPRestoredByVar2[] = _("{STR_VAR_1}'s HP was restored\nby {STR_VAR_2} point(s).{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnCuredOfPoison[] = _("{STR_VAR_1} was cured of its\npoisoning.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnCuredOfParalysis[] = _("{STR_VAR_1} was cured of\nparalysis.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnWokeUp2[] = _("{STR_VAR_1} woke up.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnBurnHealed[] = _("{STR_VAR_1}'s burn was healed.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnThawedOut[] = _("{STR_VAR_1} was thawed out.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PPWasRestored[] = _("PP was restored.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnRegainhedHealth[] = _("{STR_VAR_1} regained health.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}"); // Unused
const u8 gText_PkmnBecameHealthy[] = _("{STR_VAR_1} became healthy.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_MovesPPIncreased[] = _("{STR_VAR_1}'s PP increased.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnElevatedToLvVar2[] = _("{STR_VAR_1} was elevated to\nLv. {STR_VAR_2}.");
const u8 gText_PkmnBaseVar2StatIncreased[] = _("{STR_VAR_1}'s base {STR_VAR_2}\nstat was raised.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnFriendlyBaseVar2Fell[] = _("{STR_VAR_1} turned friendly.\nThe base {STR_VAR_2} fell!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAdoresBaseVar2Fell[] = _("{STR_VAR_1} adores you!\nThe base {STR_VAR_2} fell!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnFriendlyBaseVar2CantFall[] = _("{STR_VAR_1} turned friendly.\nThe base {STR_VAR_2} can't fall!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnSnappedOutOfConfusion[] = _("{STR_VAR_1} snapped out of its\nconfusion.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnGotOverInfatuation[] = _("{STR_VAR_1} got over its\ninfatuation.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_ThrowAwayItem[] = _("Throw away this\n{STR_VAR_1}?");
const u8 gText_ItemThrownAway[] = _("The {STR_VAR_1}\nwas thrown away.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_TeachWhichPokemon2[] = _("Teach which Pimmel?"); // Unused
const u8 gText_ChoosePokemon[] = _("Choose a Pimmel.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which Pimmel?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which Pimmel?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which Pimmel?");
...
const u8 gText_NoPokemonForBattle[] = _("No Pimmel for battle!");
const u8 gText_ChoosePokemon2[] = _("Choose a Pimmel.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} Pimmel are needed.");
const u8 gText_PokemonCantBeSame[] = _("Pimmel can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose Pimmel or Cancel.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose Pimmel and confirm.");
const u8 gText_EnjoyCycling[] = _("Let's enjoy cycling!");
const u8 gText_InUseAlready_PM[] = _("das isch in use already.");
const u8 gText_AlreadyHoldingOne[] = _("{STR_VAR_1} is already holding\none {STR_VAR_2}.");
const u8 gText_NoUse[] = _("No use.");
const u8 gText_Able[] = _("Can");
const u8 gText_First_PM[] = _("FIRST");
const u8 gText_Second_PM[] = _("SECOND");
const u8 gText_Third_PM[] = _("THIRD");
const u8 gText_Able2[] = _("Can");
const u8 gText_NotAble[] = _("Not Can");
const u8 gText_Able3[] = _("Can!");
const u8 gText_NotAble2[] = _("Not Can!");
const u8 gText_Learned[] = _("Learned");
const u8 gText_Have[] = _("Have");
const u8 gText_DontHave[] = _("Not Have");
const u8 gText_Fourth[] = _("FOURTH");
const u8 gText_PkmnCantParticipate[] = _("That Pimmel can't participate.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_CancelParticipation[] = _("Shissuf participation?");
const u8 gText_CancelBattle[] = _("Shissuf Schlegglä?");
const u8 gText_ReturnToWaitingRoom[] = _("Return to the WAITING ROOM?");
const u8 gText_CancelChallenge[] = _("Shissuf the challenge?");
...
const u8 gText_PauseUntilPress[] = _("{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That Pimmel can't be traded\nnow.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An Ei can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other Lehrer's Pimmel\ncan't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainerCantAcceptPkmn[] = _("The other Lehrer can't accept\nthat Pimmel now.");
ALIGNED(4) const u8 gText_CantTradeWithTrainer[] = _("You can't trade with that\nLehrer now.");
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of Pimmel\nthat the other Lehrer wants.");
ALIGNED(4) const u8 gText_ThatIsntAnEgg[] = _("That isn't an Ei.");
...
const u8 gText_RentalPkmn[] = _("Rental Pimmel");
const u8 gText_TypeSlash[] = _("- ");
...
const u8 gText_PkmnInfo[] = _("Pimmel Info");
const u8 gText_PkmnSkills[] = _("Pimmel Skills");
const u8 gText_BattleMoves[] = _("Kampf Moves");
const u8 gText_ContestMoves[] = _("Contest Moves");
const u8 gText_Info[] = _("Info");
const u8 gText_EggWillTakeALongTime[] = _("It looks like this Ei will\ntake a long time to hatch.");
...
const u8 gText_OddEggFoundByCouple[] = _("An odd Pimmel Ei found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar Pimmel Ei\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar Pimmel Ei\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("A Pimmel Ei obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _("An odd Pimmel Ei\nobtained from a traveler.");
const u8 gText_ApostropheSBase[] = _("'s BASE");
const u8 gText_OkayToDeleteFromRegistry[] = _("Is it okay to delete {STR_VAR_1}\nfrom the REGISTRY?");
const u8 gText_RegisteredDataDeleted[] = _("The registered data was deleted.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_NoRegistry[] = _("There is no REGISTRY.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_StoreChosenDecorInPC[] = _("Store the chosen decoration in the MAC.");
const u8 gText_ThrowAwayUnwantedDecors[] = _("Throw away unwanted decorations.");
const u8 gText_NoDecorations[] = _("There are no decorations.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_CancelDecorating[] = _("Shissuf decorating?");
const u8 gText_InUseAlready[] = _("das isch in use already.");
...
const u8 gText_ReturnDecorationToPC[] = _("Return this decoration to the MAC?");
const u8 gText_DecorationReturnedToPC[] = _("The decoration was returned to the MAC.");
const u8 gText_NoDecorationsInUse[] = _("There are no decorations in use.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_StoreItemsInPC[] = _("Store items in the MAC.");
const u8 gText_TakeOutItemsFromPC[] = _("Take out items from the MAC.");
const u8 gText_ThrowAwayItemsInPC[] = _("Throw away items stored in the MAC.");
const u8 gText_NoItems[] = _("There are no items.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_MoveToBag[] = _("MOVE TO Tüüte");
const u8 gText_Give2[] = _("GIVE");
const u8 gText_NoMailHere[] = _("There's no MAIL here.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_BagIsFull[] = _("The Tüüte is full.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_MailToBagMessageErased[] = _("The MAIL was returned to the Tüüte\nwith its message erased.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_Dad[] = _("Pappi");
const u8 gText_Mom[] = _("Mammi");
const u8 gText_Wallace[] = _("Gary");
const u8 gText_Furz[] = _("Furz");
...
const u8 gText_FreshWaterAndPrice[] = _("Quöllfrisch{CLEAR_TO 0x48}¥200");
const u8 gText_SodaPopAndPrice[] = _("Soda {CLEAR_TO 0x48}¥300");
const u8 gText_LemonadeAndPrice[] = _("iistee{CLEAR_TO 0x48}¥350");
...
const u8 gText_BattleFrontier[] = _("Kampf Frontier");
...
const u8 gText_Items[] = _("Zeugs");
const u8 gText_Key_Items[] = _("Key Zeugs");
const u8 gText_Poke_Balls[] = _("Kakk-Eier");
const u8 gText_TMs_Hms[] = _("TMs & HMs");
const u8 gText_Berries2[] = _("Beeri");
const u8 gText_SomeonesPC[] = _("Poke-Depot");
const u8 gText_LanettesPC[] = _("? Kakk");
const u8 gText_PlayersPC[] = _("Zeugs");
...
const u8 gText_BattleBag[] = _("Kampf Tüüte");
...
const u8 gText_MenuOptionPokedex[] = _("Lexikon");
const u8 gText_MenuOptionPokemon[] = _("Pimmel");
const u8 gText_MenuOptionBag[] = _("Tüüte");
const u8 gText_MenuOptionPokenav[] = _("Handi");
const u8 gText_Blank[] = _("");
const u8 gText_MenuOptionSave[] = _("Save");
const u8 gText_MenuOptionOption[] = _("Optionä");
const u8 gText_MenuOptionExit[] = _("->");
...
const u8 gText_PokemonJump[] = _("Pimmel Jump");
...
const u8 gText_BattlePts[] = _("Kampf Pts");
...
const u8 gText_BattleRules[] = _("Kampf Rules");
...
const u8 gText_BattleBasics[] = _("Kampf Basics");
const u8 gText_PokemonNature[] = _("Pimmel Nature");
const u8 gText_PokemonMoves[] = _("Pimmel Moves");
const u8 gText_Underpowered[] = _("Underpowered");
const u8 gText_WhenInDanger[] = _("When In Danger");
const u8 gText_PyramidPokemon[] = _("Pyramid: Pimmel");
const u8 gText_PyramidTrainers[] = _("Pyramid: Lehrer");
const u8 gText_PyramidMaze[] = _("Pyramid: Maze");
const u8 gText_BattleBag2[] = _("Kampf Tüüte");
const u8 gText_PokenavAndBag[] = _("Handi und Tüüte");
const u8 gText_HeldItems[] = _("Held Items");
const u8 gText_PokemonOrder[] = _("Pimmel Order");
const u8 gText_BattlePokemon[] = _("Kampf Pimmel");
const u8 gText_BattleTrainers[] = _("Kampf Lehrer");
...
const u8 gText_ReleaseThisPokemon[] = _("Release this Pimmel?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0} was released.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0}!");
const u8 gText_MarkYourPkmn[] = _("Mark your Pimmel.");
const u8 gText_ThatsYourLastPkmn[] = _("That's your last Pimmel!");
const u8 gText_YourPartysFull[] = _("Your party's full!");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding a Pimmel!");
const u8 gText_WhichOneWillYouTake[] = _("Which one will you take?");
const u8 gText_YouCantReleaseAnEgg[] = _("You can't release an Ei.");
...
const u8 gText_GiveToAPkmn[] = _("GIVE to a Pimmel?");
const u8 gText_PlacedItemInBag[] = _("Placed item in the Tüüte.");
const u8 gText_BagIsFull2[] = _("The Tüüte is full.");
const u8 gText_PutItemInBag[] = _("Put this item in the Tüüte?");
...
const u8 gPCText_Pokecenter[] = _("Spital");
...
const u8 gText_WithdrawPokemon[] = _("Withdraw Pimmel");
const u8 gText_DepositPokemon[] = _("Deposit Pimmel");
const u8 gText_MovePokemon[] = _("Move Pimmel");
const u8 gText_MoveItems[] = _("Move Items");
const u8 gText_SeeYa[] = _("Verpiss dich!");
const u8 gText_WithdrawMonDescription[] = _("Move Pimmel stored in BOXES to\nyour party.");
const u8 gText_DepositMonDescription[] = _("Store Pimmel in your party in BOXES.");
const u8 gText_MoveMonDescription[] = _("Organize the Pimmel in BOXES and\nin your party.");
const u8 gText_MoveItemsDescription[] = _("Move items held by any Pimmel\nin a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("Return to the previous menu.");
const u8 gText_JustOnePkmn[] = _("There is just one Pimmel with you.");
...
const u8 gText_CheckPokemonInDetail[] = _("Check Pimmel in detail.");
const u8 gText_CallRegisteredTrainer[] = _("Call a registered Lehrer.");
const u8 gText_CheckObtainedRibbons[] = _("Check obtained RIBBONS.");
const u8 gText_PutAwayPokenav[] = _("Put away the Handi.");
const u8 gText_NoRibbonWinners[] = _("There are no RIBBON winners.");
const u8 gText_NoTrainersRegistered[] = _("No Lehrer are registered."); // Unused
const u8 gText_CheckPartyPokemonInDetail[] = _("Check party Pimmel in detail.");
const u8 gText_CheckAllPokemonInDetail[] = _("Check all Pimmel in detail.");
const u8 gText_ReturnToPokenavMenu[] = _("Return to the Handi menu.");
const u8 gText_FindCoolPokemon[] = _("Find cool Pimmel.");
const u8 gText_FindBeautifulPokemon[] = _("Find beautiful Pimmel.");
const u8 gText_FindCutePokemon[] = _("Find cute Pimmel.");
const u8 gText_FindSmartPokemon[] = _("Find smart Pimmel.");
const u8 gText_FindToughPokemon[] = _("Find tough Pimmel.");
...
const u8 gText_PokenavMatchCall_Strategy[] = _("Stragegy");
const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("Lehrer's Pimmel");
...
const u8 gText_TrainerCloseBy[] = _("That Lehrer is close by.\nTalk to the Lehrer in person!");
...
const u8 gText_TheTrainersImage[] = _("the Lehrer's image.");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the Pimmel MAIL?");
...
const u8 gText_StopGivingPkmnMail2[] = _("Stop giving the Pimmel MAIL?"); // Unused
const u8 gText_CreateAQuiz2[] = _("Create a quiz!"); // Unused
const u8 gText_SetTheAnswer[] = _("Set the answer!"); // Unused
const u8 gText_CancelSelection[] = _("Shiisuf the selection?"); // Unused
...
const u8 gText_PokemonLeague[] = _("Pimmel LEAGUE");
const u8 gText_PokemonCenter[] = _("Pimmel CENTER");
...
const u8 gText_PokemonTrades[] = _("Pimmel TRADES");
const u8 gText_UnionTradesAndBattles[] = _("UNION TRADES & BATTLES");
const u8 gText_BerryCrush[] = _("BERRY CRUSH");
const u8 gText_WaitingTrainerFinishReading[] = _("Waiting for the other Skilehrer to\nfinish reading your Skilehrer CARD.");
...
const u8 gText_BattlePtsWon[] = _("Kampf POINTS WON");
const u8 gText_NumBP[] = _("{STR_VAR_1}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}BP");
const u8 gText_BattleTower[] = _("Penis Turm");
...
const u8 gText_BattleTower2[] = _("Penis Turm");
const u8 gText_BattleDome[] = _("Kampf Dome");
const u8 gText_BattlePalace[] = _("Kampf Palace");
const u8 gText_BattleFactory[] = _("Kampf Factory");
const u8 gText_BattleArena[] = _("Kampf Arena");
const u8 gText_BattlePike[] = _("Kampf Pike");
const u8 gText_BattlePyramid[] = _("Kampf Pyramid");
...
const u8 gText_AlreadySavedFile_Chat[] = _("Saving...");
const u8 gText_SavingDontTurnOff_Chat[] = _("Saving...");
const u8 gText_PlayerSavedGame_Chat[] = _("{DYNAMIC 0} saved.");
const u8 gText_IfLeaderLeavesChatEnds[] = _("If the LEADER leaves, the chat\nwill end. Is that okay?");
const u8 gText_Hello[] = _("Hello");
const u8 gText_Pokemon2[] = _("Pimmel");
const u8 gText_Trade[] = _("Trade");
const u8 gText_Battle[] = _("Bättle");
const u8 gText_Lets[] = _("Let's");
const u8 gText_Ok[] = _("Oké!");
const u8 gText_Sorry[] = _("Sorry");
const u8 gText_YaySmileEmoji[] = _("Yay{EMOJI_BIGSMILE}");
const u8 gText_ThankYou[] = _("Dankee");
const u8 gText_ByeBye[] = _("Verpiss dich!");
const u8 gText_MatchCallFurz_Strategy[] = _("Attack the weak points!");
const u8 gText_MatchCallFurz_Pokemon[] = _("Ultimate Stahl Pimmel.");
const u8 gText_MatchCallFurz_Intro1_BeforeMeteorFallsBattle[] = _("I'd climb even waterfalls");
const u8 gText_MatchCallFurz_Intro2_BeforeMeteorFallsBattle[] = _("to find a rare stone!");
const u8 gText_MatchCallFurz_Intro1_AfterMeteorFallsBattle[] = _("I'm the strongest and most");
const u8 gText_MatchCallFurz_Intro2_AfterMeteorFallsBattle[] = _("energetic after all!");
const u8 gText_MatchCallBrendan_Strategy[] = _("Kampf with knowledge!");
const u8 gText_MatchCallBrendan_Pokemon[] = _("I will use various Pimmel.");
const u8 gText_MatchCallBrendan_Intro1[] = _("I'll be a better Pimmel");
...
const u8 gText_MatchCallMay_Pokemon[] = _("I'll use any Pimmel!");
const u8 gText_MatchCallMay_Intro1[] = _("My Pimmel and I help");
const u8 gText_MatchCallMay_Intro2[] = _("my father's research.");
const u8 gText_HatchedFromEgg[] = _("{STR_VAR_1} hatched from the Ei!");
...
ALIGNED(4) const u8 gText_RecordingGameResults[] = _("Saving...");
...
ALIGNED(4) const u8 gText_TimeColon[] = _("Zii:");
...
const u8 gText_BattleRecord[] = _("Kampf Record");
const u8 gText_BattlePoints[] = _("Kampf Points");
...
const u8 gText_CheckTrainerCard[] = _("Check Skilehrer CARD.");
...
const u8 gText_BattleTowerAbilitySymbol[] = _("Kampf Tower - Ability Symbol");
const u8 gText_BattleDomeTacticsSymbol[] = _("Kampf Dome - Tactics Symbol");
const u8 gText_BattlePalaceSpiritsSymbol[] = _("Kampf Palace - Spirits Symbol");
const u8 gText_BattleArenaGutsSymbol[] = _("Kampf Arena - Guts Symbol");
const u8 gText_BattleFactoryKnowledgeSymbol[] = _("Kampf Factory - Knowledge Symbol");
const u8 gText_BattlePikeLuckSymbol[] = _("Kampf Pike - Luck Symbol");
const u8 gText_BattlePyramidBraveSymbol[] = _("Kampf Pyramid - Brave Symbol");
const u8 gText_ThereIsNoBattleRecord[] = _("There is no Battle Record.");
const u8 gText_BattleTower3[] = _("Penis Turm");
const u8 gText_BattleDome2[] = _("Kampf Dome");
const u8 gText_BattlePalace2[] = _("Kampf Palace");
const u8 gText_BattleArena2[] = _("Kampf Arena");
const u8 gText_BattleFactory2[] = _("Kampf Factory");
const u8 gText_BattlePike2[] = _("Kampf Pike");
const u8 gText_BattlePyramid2[] = _("Kampf Pyramid");
...
const u8 gText_BattlePalaceDesc[] = _("Watch your Pimmel battle!\nYour spirit will be tested.");
const u8 gText_BattleArenaDesc[] = _("Win battles with teamed-up Pimmel!\nYour guts will be tested.");
const u8 gText_BattleFactoryDesc[] = _("Aim for victory using rental Pimmel!\nYour knowledge will be tested.");
...
const u8 gText_ContinueMenuPlayer[] = _("Penner");
const u8 gText_ContinueMenuTime[] = _("Ziit");
const u8 gText_ContinueMenuPokedex[] = _("Pimmel-Lexikon");
const u8 gText_ContinueMenuBadges[] = _("Ufkleber");
...
const u8 gText_PkmnJumpRecords[] = _("Pimmel JUMP RECORDS");
...
const u8 gText_Option[] = _("Optionä");
const u8 gText_TextSpeed[] = _("Text Speeed");
const u8 gText_BattleScene[] = _("Kampf Scene");
const u8 gText_BattleStyle[] = _("Kampf Style");
const u8 gText_Sound[] = _("Musig");
...
const u8 gText_TimeColon2[] = _("Ziit:"); // Unused
...
const u8 gText_MenuPokedex[] = _("Lexikon");
const u8 gText_MenuPokemon[] = _("Pimmel");
const u8 gText_MenuBag[] = _("Tüüte");
const u8 gText_MenuPokenav[] = _("Handi");
const u8 gText_MenuPlayer[] = _("{PLAYER}");
const u8 gText_MenuSave[] = _("Save");
const u8 gText_MenuOption[] = _("Optionä");
const u8 gText_MenuExit[] = _("->"); //_("Exit");
const u8 gText_MenuRetire[] = _("Retire");
const u8 gText_MenuRest[] = _("Chill");
const u8 gText_SafariBallStock[] = _("SAFARI-Eier\nStock: {STR_VAR_1}");
const u8 gText_BattlePyramidFloor[] = _("Kampf Pyramid\n{STR_VAR_1}");
...
const u8 gText_PokedexDiploma[] = _("Penner: {CLEAR 0x10}{COLOR RED}{SHADOW LIGHT_RED}{PLAYER}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}\n\nThis document certifies\nthat you have successfully\ncompleted your\n{STR_VAR_1} Pimmel-Lexikon.\n\n{CLEAR_TO 0x42}{COLOR RED}{SHADOW LIGHT_RED}GAME FREAK");
...
const u8 gText_OhABite[] = _("Shit! A bite!");
const u8 gText_PokemonOnHook[] = _("A Pimmel's on the hook!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_NotEvenANibble[] = _("Not even a nibble…{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_ItGotAway[] = _("It got away…{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gEasyChatGroupName_Pokemon[] = _("Pimmel");
const u8 gEasyChatGroupName_Trainer[] = _("Lehrer");
const u8 gEasyChatGroupName_Status[] = _("Status");
const u8 gEasyChatGroupName_Battle[] = _("Fight");
const u8 gEasyChatGroupName_Greetings[] = _("Ciao");
const u8 gEasyChatGroupName_People[] = _("Pöbel");
const u8 gEasyChatGroupName_Voices[] = _("Voiced");
...
const u8 gEasyChatGroupName_Hobbies[] = _("Freiziit");
const u8 gEasyChatGroupName_Time[] = _("Ziit");
const u8 gEasyChatGroupName_Misc[] = _("Zeugs");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("Pimmel2");

const u8 gText_ThreeQuestionMarks[] = _("???");
const u8 gText_MaxHP[] = _("Max Life");
...
const u8 gText_YourName[] = _("Din Name??");
...
const u8 gText_RentalPkmn2[] = _("Rental Pimmel");
const u8 gText_SelectFirstPkmn[] = _("Select the first Pimmel.");
const u8 gText_SelectSecondPkmn[] = _("Select the second Pimmel.");
const u8 gText_SelectThirdPkmn[] = _("Select the third Pimmel.");
...
const u8 gText_TheseThreePkmnOkay[] = _("Are these three Pimmel Oké?");
const u8 gText_Yes2[] = _("Jaa");
const u8 gText_No2[] = _("Neii");
const u8 gText_CantSelectSamePkmn[] = _("Can't select same {PKMN}.");
const u8 gText_PkmnSwap[] = _("Pimmel SWAP");
const u8 gText_SelectPkmnToSwap[] = _("Select Pimmel to swap.");
const u8 gText_SelectPkmnToAccept[] = _("Select Pimmel to accept.");
...
const u8 gText_No3[] = _("Neii");
const u8 gText_PkmnForSwap[] = _("{PKMN} für Swap");
const u8 gText_Cancel3[] = _("Cancel");
const u8 gText_Swap2[] = _("Swap"); // Unused
const u8 gText_Accept[] = _("Accept"); // Unused
const u8 gText_AcceptThisPkmn[] = _("Accept this Pimmel?");
...
const u8 gText_SavingPlayer[] = _("Penner");
const u8 gText_SavingBadges[] = _("Ufkleber");
const u8 gText_SavingPokedex[] = _("Pimmel-Lexikon");
const u8 gText_SavingTime[] = _("Ziit");
...
const u8 gText_PeopleInUnionRoom[] = _("People in the Stripclub:");
...
ALIGNED(4) const u8 gText_Exit3[] = _("->"); //_("Exit");
...
ALIGNED(4) const u8 gText_NewTrainerReceived[] = _("A new Skilehrer has arrived.");
...
ALIGNED(4) const u8 gText_OtherTrainerHasCard[] = _("The other Skilehrer has the same\nWONDER CARD already.");
ALIGNED(4) const u8 gText_OtherTrainerHasNews[] = _("The other Skilehrer has the same\nWONDER NEWS already.");
ALIGNED(4) const u8 gText_OtherTrainerHasStamp[] = _("The other Skilehrer has the same\nSTAMP already.");
ALIGNED(4) const u8 gText_OtherTrainerCanceled[] = _("The other Skilehrer canceled\ncommunication.");
...
const u8 gText_YouveGot9999Coins[] = _("You've got 9999 Kohlä.");
const u8 gText_YouveRunOutOfCoins[] = _("You've run out of Kohlä.\nGame over!");
const u8 gText_YouDontHaveThreeCoins[] = _("You don't have three Kohlä.");
const u8 gText_ReelTimeHelp[] = _("Reel Ziit\nHere's your chance to take\naim and nail marks!\nReel Time continues for the\nawarded number of spins.\nIt all ends on a Big Bonus.");
...
const u8 gText_MoveRelearnerBattleMoves[] = _("Kampf MOVES");
...
const u8 gText_FurzMatchCallDesc[] = _("Hard As Penis");
const u8 gText_FurzMatchCallName[] = _("Furz");
...
const u8 gText_WallyMatchCallDesc[] = _("{PKMN} Liebi");
const u8 gText_NormanMatchCallName[] = _("Pappi");
const u8 gText_MomMatchCallName[] = _("Mammi");
...
const u8 gText_EliteFourMatchCallDesc[] = _("Elite Penis");
const u8 gText_ChampionMatchCallDesc[] = _("Champion");
const u8 gText_ProfBirchMatchCallDesc[] = _("{PKMN} Dr.");
...
const u8 gText_PokeBalls[] = _("Kakk-Eier");
