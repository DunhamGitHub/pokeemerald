...
const u8 gText_SaveFileCorrupted[] = _("S'Save-File isch am Arsch!\nNo way dude, wieder was gschlisse.\nMir nämed s'Letscht halt..");
...
const u8 gText_MenuOptionPokenav[] = _("GPS");
...
const u8 gText_PokenavAndBag[] = _("Gps And Tüüte");
...
const u8 gText_PutAwayPokenav[] = _("Put away the GPS.");
...
const u8 gText_ReturnToPokenavMenu[] = _("Return to the GPS menu.");
...
const u8 gText_SavingDontTurnOff2[] = _("Speichers…\nMach jetzt kein Scheiss.");
...
const u8 gText_MenuPokenav[] = _("GPS");
