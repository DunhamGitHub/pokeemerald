...
const u8 gText_ThisIsAPokemon[] = _("Das Kakkteil heisst “Penner.”{PAUSE 96}\p");
...
const u8 gText_CantDismountBike[] = _("You can't dismount your Vélo here.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild Pimmel will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild Pimmel will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_YouDontHaveMoney[] = _("Du bisch zu Pleite, Penner!.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreRoomForThis[] = _("Kei Platz meh für das Zeug.{PAUSE_UNTIL_PRESS}");
const u8 gText_SpaceForVar1Full[] = _("Kei Platz meh für {STR_VAR_1}.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThrowInPremierBall[] = _("Ich gib der gratis än PREMIER BALL.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_CantSwitchWithAlly[] = _("You can't switch {STR_VAR_1}'s\nPimmel with one of yours!{PAUSE_UNTIL_PRESS}");
const u8 gText_EggCantBattle[] = _("An Ei can't battle!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MailSentToPC[] = _("The MAIL was sent to your MAC.{PAUSE_UNTIL_PRESS}");
const u8 gText_PCMailboxFull[] = _("Your MAC's MAILBOX is full.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnCantParticipate[] = _("That Pimmel can't participate.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_BagIsFull[] = _("The Tüüte is full.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PokemonOnHook[] = _("A Pimmel's on the hook!{PAUSE_UNTIL_PRESS}");
