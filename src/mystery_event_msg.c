...
const u8 gText_MysteryEventNationalDex[] = _("The Pimmel-Lexikon has been upgraded\nwith the NATIONAL MODE.");
...
const u8 gText_MysteryEventNewTrainer[] = _("A new Skilehrer has arrived in\nHOENN.");
