...
static const u8 sText_PkmnGainedEXP[] = _("{B_BUFF1} bechunt{B_BUFF2}\n{B_BUFF3} Pünkt!{PAUSE 32}"); // \p"); was here
static const u8 sText_EmptyString4[] = _("");
static const u8 sText_ABoosted[] = _(" a boosted");
static const u8 sText_PkmnGrewToLv[] = _("{B_BUFF1} stiigt uuf zu\nLevel {B_BUFF2} (woa Rakeete)!{WAIT_SE}{PAUSE 32}"); // \p"); was here
static const u8 sText_PkmnLearnedMove[] = _("{B_BUFF1} hät glernt\n{B_BUFF2}!{WAIT_SE}{PAUSE 32}"); // \p"); was here
static const u8 sText_TryToLearnMove1[] = _("{B_BUFF1} probiert\nz'lerne {B_BUFF2}.{PAUSE 32}"); // \p"); was here
static const u8 sText_TryToLearnMove2[] = _("Shit, {B_BUFF1} chan aber\nnur 4 Moves lerne.{PAUSE 32}"); // \p"); was here
static const u8 sText_TryToLearnMove3[] = _("Schiss druf, eine lösche\nfür {B_BUFF2}?");
static const u8 sText_PkmnForgotMove[] = _("{B_BUFF1} vergisst\n{B_BUFF2}.{PAUSE 32}"); // \p"); was here
static const u8 sText_StopLearningMove[] = _("{PAUSE 32}Uf {B_BUFF2} schisse (nöd lernä)?");
static const u8 sText_DidNotLearnMove[] = _("{B_BUFF1} hät {B_BUFF2} nöd glernt.{PAUSE 32}"); // \p"); was here
static const u8 sText_UseNextPkmn[] = _("Next arme Siech ineschicke?");
static const u8 sText_AttackMissed[] = _("{B_ATK_NAME_WITH_PREFIX}'s\nhät's verkakkt!");
static const u8 sText_PkmnProtectedItself[] = _("{B_DEF_NAME_WITH_PREFIX}\nschützt sich (sone Pumpi)…!");
static const u8 sText_AvoidedDamage[] = _("{B_DEF_NAME_WITH_PREFIX} avoided\ndamage with {B_DEF_ABILITY}!");
static const u8 sText_PkmnMakesGroundMiss[] = _("{B_DEF_NAME_WITH_PREFIX} makes GROUND\nmoves miss with {B_DEF_ABILITY}!");
static const u8 sText_PkmnAvoidedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} het sich\nversteckt (wie e Skilehrer)!");
static const u8 sText_ItDoesntAffect[] = _("It doesn't affect\n{B_DEF_NAME_WITH_PREFIX}…");
static const u8 sText_AttackerFainted[] = _("{B_ATK_NAME_WITH_PREFIX}\nchans nöd take!{PAUSE 32}"); // \p"); was here // _("{B_ATK_NAME_WITH_PREFIX}\nfainted!{PAUSE 32}"); // \p"); was here
static const u8 sText_TargetFainted[] = _("{B_DEF_NAME_WITH_PREFIX}\nchans nöd take!{PAUSE 32}"); // \p"); was here
static const u8 sText_PlayerGotMoney[] = _("{B_PLAYER_NAME} bechunt ¥{B_BUFF1} zum Sieg!{PAUSE 32}"); // \p"); was here
static const u8 sText_PlayerWhiteout[] = _("{B_PLAYER_NAME} het kei\nPimmel meh!{PAUSE 32}"); // \p"); was here
static const u8 sText_PlayerWhiteout2[] = _("{B_PLAYER_NAME} muss is Spital!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
static const u8 sText_PreventsEscape[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} prevents\nescape with {B_SCR_ACTIVE_ABILITY}!{PAUSE 32}"); // \p"); was here
static const u8 sText_CantEscape2[] = _("Verpisse isch unpossible!{PAUSE 32}"); // \p"); was here
static const u8 sText_AttackerCantEscape[] = _("{B_ATK_NAME_WITH_PREFIX} chan sich nöd verpisse!");
static const u8 sText_HitXTimes[] = _("Haut {B_BUFF1} Mal id Frässi!");
static const u8 sText_PkmnFellAsleep[] = _("{B_EFF_NAME_WITH_PREFIX}\nisch ipennt!");
static const u8 sText_PkmnMadeSleep[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nlaht {B_EFF_NAME_WITH_PREFIX} ipennt!");
static const u8 sText_PkmnAlreadyAsleep[] = _("{B_DEF_NAME_WITH_PREFIX} isch\nscho am Penne!");
static const u8 sText_PkmnAlreadyAsleep2[] = _("{B_ATK_NAME_WITH_PREFIX} isch\nscho am Penne!");
static const u8 sText_PkmnWasntAffected[] = _("{B_DEF_NAME_WITH_PREFIX}\nschisst druf!");
static const u8 sText_PkmnWasPoisoned[] = _("{B_EFF_NAME_WITH_PREFIX}\nisch bsoffe!");
static const u8 sText_PkmnPoisonedBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nvergiftet {B_EFF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnHurtByPoison[] = _("{B_ATK_NAME_WITH_PREFIX} find s'Gift\nnöd geil!");
static const u8 sText_PkmnAlreadyPoisoned[] = _("{B_DEF_NAME_WITH_PREFIX} isch scho\nvergiftet.");
static const u8 sText_PkmnBadlyPoisoned[] = _("{B_EFF_NAME_WITH_PREFIX} is böss\nbsoffe!");
static const u8 sText_PkmnEnergyDrained[] = _("{B_DEF_NAME_WITH_PREFIX} het\nEnergie abgäh!");
static const u8 sText_PkmnWasBurned[] = _("{B_EFF_NAME_WITH_PREFIX} wird abgfacklet!");
static const u8 sText_PkmnBurnedBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nfacklet {B_EFF_NAME_WITH_PREFIX} ab!");
static const u8 sText_PkmnHurtByBurn[] = _("{B_ATK_NAME_WITH_PREFIX} find\nd'Vergrennig ungeil!");
static const u8 sText_PkmnAlreadyHasBurn[] = _("{B_DEF_NAME_WITH_PREFIX} isch\nscho verbrennt.");
static const u8 sText_PkmnWasFrozen[] = _("{B_EFF_NAME_WITH_PREFIX} isch\nigfohre (voll wie Glacé)!");
static const u8 sText_PkmnFrozenBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} hät\n{B_EFF_NAME_WITH_PREFIX} zu Glacé gmacht!");
static const u8 sText_PkmnIsFrozen[] = _("{B_ATK_NAME_WITH_PREFIX} isch\nSchoggi-Glacé worde!");
static const u8 sText_PkmnWasDefrosted[] = _("{B_DEF_NAME_WITH_PREFIX} isch\nuftaut (geil)!");
static const u8 sText_PkmnWasDefrosted2[] = _("{B_ATK_NAME_WITH_PREFIX} isch\nvoll uftaut!");
static const u8 sText_PkmnWasDefrostedBy[] = _("{B_ATK_NAME_WITH_PREFIX} isch uftaut\nworde durch {B_CURRENT_MOVE}!");
static const u8 sText_PkmnWasParalyzed[] = _("{B_EFF_NAME_WITH_PREFIX} isch b'hinderet!\nMuss vermuetlich ussetze!");
static const u8 sText_PkmnWasParalyzedBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} hät\n{B_EFF_NAME_WITH_PREFIX} b'hinderet gmacht!");
static const u8 sText_PkmnIsParalyzed[] = _("{B_ATK_NAME_WITH_PREFIX} isch b'hinderet!\nMuss ussetze!");
static const u8 sText_PkmnIsAlreadyParalyzed[] = _("{B_DEF_NAME_WITH_PREFIX} isch\nscho b'hinderet!");
static const u8 sText_PkmnHealedParalysis[] = _("{B_DEF_NAME_WITH_PREFIX} isch\nnümme b'hinderet!");
static const u8 sText_PkmnDreamEaten[] = _("Dä Traum vo {B_DEF_NAME_WITH_PREFIX}\nisch g'ässe worde (krass)!");
static const u8 sText_StatsWontIncrease[] = _("Dä {B_BUFF1} vo {B_ATK_NAME_WITH_PREFIX}\ngaht nöd höcher!");
static const u8 sText_StatsWontDecrease[] = _("Dä {B_BUFF1} vo {B_DEF_NAME_WITH_PREFIX}\ngaht nöd tüüfer!");
static const u8 sText_TeamStoppedWorking[] = _("S'{B_BUFF1} vo dim Team\nisch böös fucked-up!");
static const u8 sText_FoeStoppedWorking[] = _("Dä {B_BUFF1} vom Penner\nfunktioniert nüm!");
...
static const u8 sText_PkmnAlreadyConfused[] = _("{B_DEF_NAME_WITH_PREFIX} isch\nscho messed up böös!");
static const u8 sText_PkmnFellInLove[] = _("{B_DEF_NAME_WITH_PREFIX}\nisch in Liebi!");
static const u8 sText_PkmnInLove[] = _("{B_ATK_NAME_WITH_PREFIX} wott\n{B_SCR_ACTIVE_NAME_WITH_PREFIX} vöggle!");
static const u8 sText_PkmnImmobilizedByLove[] = _("{B_ATK_NAME_WITH_PREFIX} \nchans nöd take!");
static const u8 sText_PkmnBlownAway[] = _("{B_DEF_NAME_WITH_PREFIX} \nischveggblaase worde!");
static const u8 sText_PkmnChangedType[] = _("{B_ATK_NAME_WITH_PREFIX} het sich\nin {B_BUFF1} Typ verwandlet!");
static const u8 sText_PkmnFlinched[] = _("{B_ATK_NAME_WITH_PREFIX} finds ungeil!");
...
static const u8 sText_PkmnRaisedSpDefALittle[] = _("{B_ATK_PREFIX2}'s {B_CURRENT_MOVE}\nbechunt es Bizzli meh Sp. Def!");
static const u8 sText_PkmnRaisedDef[] = _("{B_ATK_PREFIX2}'s {B_CURRENT_MOVE}\nbechunt meh DEFENSE!");
static const u8 sText_PkmnRaisedDefALittle[] = _("{B_ATK_PREFIX2}'s {B_CURRENT_MOVE}\nbechunt es Bizzli meh DEFENSE!");
static const u8 sText_PkmnCoveredByVeil[] = _("{B_ATK_PREFIX2}'s party is covered\nby a veil (Gay!)!");
static const u8 sText_PkmnUsedSafeguard[] = _("{B_DEF_NAME_WITH_PREFIX}'s party is protected\nby SAFEGUARD (Gay!)!");
static const u8 sText_PkmnSafeguardExpired[] = _("{B_ATK_PREFIX3}'s party is no longer\nprotected by SAFEGUARD! (Gay!)!");
static const u8 sText_PkmnWentToSleep[] = _("{B_ATK_NAME_WITH_PREFIX} isch\ngo penne!");
static const u8 sText_PkmnSleptHealthy[] = _("{B_ATK_NAME_WITH_PREFIX} hät pennt&\nund isch gsund!");
static const u8 sText_PkmnWhippedWhirlwind[] = _("{B_ATK_NAME_WITH_PREFIX} macht\nvoll Wirbelwind mannn!");
static const u8 sText_PkmnTookSunlight[] = _("{B_ATK_NAME_WITH_PREFIX} gaht\nin Tussitoschter!");
static const u8 sText_PkmnLoweredHead[] = _("{B_ATK_NAME_WITH_PREFIX} macht\nLiggestüzz!");
static const u8 sText_PkmnIsGlowing[] = _("{B_ATK_NAME_WITH_PREFIX} glänzt krass!");
static const u8 sText_PkmnFlewHigh[] = _("{B_ATK_NAME_WITH_PREFIX} flügt\nid Luft ihms!");
static const u8 sText_PkmnDugHole[] = _("{B_ATK_NAME_WITH_PREFIX} macht Loch!");
static const u8 sText_PkmnHidUnderwater[] = _("{B_ATK_NAME_WITH_PREFIX} versteckt\nsich under dem Wasser!");
static const u8 sText_PkmnSprangUp[] = _("{B_ATK_NAME_WITH_PREFIX} macht Gump!");
static const u8 sText_PkmnSqueezedByBind[] = _("{B_DEF_NAME_WITH_PREFIX} wird durch\n{B_ATK_NAME_WITH_PREFIX}'s druckt!");
static const u8 sText_PkmnTrappedInVortex[] = _("{B_DEF_NAME_WITH_PREFIX} isch\ngfange worde!");
static const u8 sText_PkmnTrappedBySandTomb[] = _("{B_DEF_NAME_WITH_PREFIX} isch gfange\nvom SAND TOMB!");
static const u8 sText_PkmnWrappedBy[] = _("{B_DEF_NAME_WITH_PREFIX} isch g'WRAPPED \nworde vo {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnClamped[] = _("{B_ATK_NAME_WITH_PREFIX} CLAMPED\n{B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnHurtBy[] = _("{B_ATK_NAME_WITH_PREFIX} tut\n{B_BUFF1} mega fescht weh!");
static const u8 sText_PkmnFreedFrom[] = _("{B_ATK_NAME_WITH_PREFIX} entflüüht\ndurch {B_BUFF1}!");
static const u8 sText_PkmnCrashed[] = _("{B_ATK_NAME_WITH_PREFIX} secklet\n...und gheit uf d'Frässi!");
const u8 gText_PkmnShroudedInMist[] = _("{B_ATK_PREFIX2} wird\nag'furzt!");
static const u8 sText_PkmnProtectedByMist[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} isch geschützt\nvom Furz!");
const u8 gText_PkmnGettingPumped[] = _("{B_ATK_NAME_WITH_PREFIX} macht sich parat\nzum Frässi-poliere!");
static const u8 sText_PkmnHitWithRecoil[] = _("{B_ATK_NAME_WITH_PREFIX} haut sich\nselber id Frässi!");
static const u8 sText_PkmnProtectedItself2[] = _("{B_ATK_NAME_WITH_PREFIX} zieht Jagge ah!");
static const u8 sText_PkmnBuffetedBySandstorm[] = _("{B_ATK_NAME_WITH_PREFIX} chunt vom\nSandsturm eis id Frässi!");
static const u8 sText_PkmnPeltedByHail[] = _("{B_ATK_NAME_WITH_PREFIX} chunt\neis id Frässi über!");
static const u8 sText_PkmnsXWoreOff[] = _("{B_ATK_PREFIX1}'s {B_BUFF1}\nhet kei Parfüm meh!");
static const u8 sText_PkmnSeeded[] = _("{B_DEF_NAME_WITH_PREFIX} isch apisst worde!");
static const u8 sText_PkmnEvadedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} hets\nnöd verwütscht!");
static const u8 sText_PkmnSappedByLeechSeed[] = _("{B_ATK_NAME_WITH_PREFIX}'s Life isch\nbeiflusst durch LEECH SEED!");
static const u8 sText_PkmnFastAsleep[] = _("{B_ATK_NAME_WITH_PREFIX} isch am Penne!");
static const u8 sText_PkmnWokeUp[] = _("{B_ATK_NAME_WITH_PREFIX} isch ufgwacht!");
static const u8 sText_PkmnUproarKeptAwake[] = _("Aber {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s UPROAR\nlaht ihn nöd go Penne!");
static const u8 sText_PkmnWokeUpInUproar[] = _("{B_ATK_NAME_WITH_PREFIX} isch ihm\nUPROAR ufgwacht!");
static const u8 sText_PkmnCausedUproar[] = _("{B_ATK_NAME_WITH_PREFIX} verursacht\nän UPROAR (wtf is that?)!");
static const u8 sText_PkmnMakingUproar[] = _("{B_ATK_NAME_WITH_PREFIX} macht\nän UPROAR (wtf is that?)!");
static const u8 sText_PkmnCalmedDown[] = _("{B_ATK_NAME_WITH_PREFIX} chillaxt.");
static const u8 sText_PkmnCantSleepInUproar[] = _("Aber {B_DEF_NAME_WITH_PREFIX} chan nöd\ngo Penne im UPROAR!");
static const u8 sText_PkmnStockpiled[] = _("{B_ATK_NAME_WITH_PREFIX} STOCKPILED\n{B_BUFF1}!");
static const u8 sText_PkmnCantStockpile[] = _("{B_ATK_NAME_WITH_PREFIX} chan nöd\nSTOCKPILE meh!");
static const u8 sText_PkmnCantSleepInUproar2[] = _("Aber {B_DEF_NAME_WITH_PREFIX} chan nöd\ngo Penne wänn UPROAR isch!");
static const u8 sText_UproarKeptPkmnAwake[] = _("Aber dä UPROAR laht\n{B_DEF_NAME_WITH_PREFIX} nöd go Penne!");
static const u8 sText_PkmnStayedAwakeUsing[] = _("{B_DEF_NAME_WITH_PREFIX} blibt wach\nwäge däm {B_DEF_ABILITY}!");
static const u8 sText_PkmnStoringEnergy[] = _("{B_ATK_NAME_WITH_PREFIX} speicheret\nvoll Energie, mannn!");
static const u8 sText_PkmnUnleashedEnergy[] = _("{B_ATK_NAME_WITH_PREFIX} lasst\nEnergie frei (geil)!");
static const u8 sText_PkmnFatigueConfusion[] = _("{B_ATK_NAME_WITH_PREFIX} wird \nb'hinderet well es müäd isch!");
static const u8 sText_PlayerPickedUpMoney[] = _("{B_PLAYER_NAME} nimmt ¥{B_BUFF1}!{PAUSE 32}"); // \p"); was here
static const u8 sText_PkmnUnaffected[] = _("{B_DEF_NAME_WITH_PREFIX} isch\nalles Scheissegal!");
static const u8 sText_PkmnTransformedInto[] = _("{B_ATK_NAME_WITH_PREFIX} wird zu\n{B_BUFF1} (geil)!");
static const u8 sText_PkmnMadeSubstitute[] = _("{B_ATK_NAME_WITH_PREFIX} macht\nän SUBSTITUTE!");
static const u8 sText_PkmnHasSubstitute[] = _("{B_ATK_NAME_WITH_PREFIX} hät\nscho än SUBSTITUTE!");
static const u8 sText_SubstituteDamaged[] = _("Dä SUBSTITUTE tuäd mega weh\nfür {B_DEF_NAME_WITH_PREFIX}!{PAUSE 32}"); // \p"); was here
static const u8 sText_PkmnSubstituteFaded[] = _("{B_DEF_NAME_WITH_PREFIX}'s\nSUBSTITUTE isch verbii!{PAUSE 32}"); // \p"); was here
static const u8 sText_PkmnMustRecharge[] = _("{B_ATK_NAME_WITH_PREFIX} muss\nussetze (chans nöd take)!");
static const u8 sText_PkmnRageBuilding[] = _("{B_DEF_NAME_WITH_PREFIX}\nwird verruckt (wie en Jugo)!");
static const u8 sText_PkmnMoveWasDisabled[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}\nisch voll kaputt!");
static const u8 sText_PkmnMoveDisabledNoMore[] = _("{B_ATK_NAME_WITH_PREFIX} gaht\nwidder (yeeh)!");
static const u8 sText_PkmnGotEncore[] = _("{B_DEF_NAME_WITH_PREFIX} bechunt\näs ENCORE!");
static const u8 sText_PkmnEncoreEnded[] = _("{B_ATK_NAME_WITH_PREFIX}'s ENCORE\nisch verbii!");
static const u8 sText_PkmnTookAim[] = _("{B_ATK_NAME_WITH_PREFIX} nimmt Ziel\nuf {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnSketchedMove[] = _("{B_ATK_NAME_WITH_PREFIX} SKETCHED\n{B_BUFF1}!");
static const u8 sText_PkmnTryingToTakeFoe[] = _("{B_ATK_NAME_WITH_PREFIX} probiiert\nde Gegner mitznää!");
static const u8 sText_PkmnTookFoe[] = _("{B_DEF_NAME_WITH_PREFIX} nimmt\n{B_ATK_NAME_WITH_PREFIX} mit!");
static const u8 sText_PkmnReducedPP[] = _("Reduziert {B_DEF_NAME_WITH_PREFIX}'s\n{B_BUFF1} durch {B_BUFF2}!");
static const u8 sText_PkmnStoleItem[] = _("{B_ATK_NAME_WITH_PREFIX} klaut\n{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}!");
static const u8 sText_TargetCantEscapeNow[] = _("{B_DEF_NAME_WITH_PREFIX} chan\nsich nöd verpisse!");
static const u8 sText_PkmnFellIntoNightmare[] = _("{B_DEF_NAME_WITH_PREFIX} gaht\ngo Penne (Alptraum)!");
static const u8 sText_PkmnLockedInNightmare[] = _("{B_ATK_NAME_WITH_PREFIX} isch am\nPenne (Alptraum)!");
static const u8 sText_PkmnLaidCurse[] = _("{B_ATK_NAME_WITH_PREFIX} tut sich selber weh&\nund verfluucht {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnAfflictedByCurse[] = _("{B_ATK_NAME_WITH_PREFIX} find de\nFluuch sehr ungeil!");
static const u8 sText_SpikesScattered[] = _("SPIKES sind überall um\nde Penner det ume!");
static const u8 sText_PkmnHurtBySpikes[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} tuet weh\ndurch SPIKES!");
static const u8 sText_PkmnIdentified[] = _("{B_ATK_NAME_WITH_PREFIX} gseht\n{B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnPerishCountFell[] = _("{B_ATK_NAME_WITH_PREFIX}'s macht irgendwass\nund gaht abe durch {B_BUFF1}!");
static const u8 sText_PkmnBracedItself[] = _("{B_ATK_NAME_WITH_PREFIX}\ntrinkt en iistee!");
static const u8 sText_PkmnEnduredHit[] = _("{B_DEF_NAME_WITH_PREFIX} chans Take!");
static const u8 sText_MagnitudeStrength[] = _("MAGNITUDE (geilo) {B_BUFF1}!");
static const u8 sText_PkmnCutHPMaxedAttack[] = _("{B_ATK_NAME_WITH_PREFIX} nimmt sich Läbä\nwäg und maximiert Attacke!");
static const u8 sText_PkmnCopiedStatChanges[] = _("{B_ATK_NAME_WITH_PREFIX} klaut\n{B_DEF_NAME_WITH_PREFIX}'s stat changes!");
static const u8 sText_PkmnGotFree[] = _("{B_ATK_NAME_WITH_PREFIX} befreit sich vo\n{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}!");
static const u8 sText_PkmnShedLeechSeed[] = _("{B_ATK_NAME_WITH_PREFIX} befreit\nsich vo LEECH SEED!");
static const u8 sText_PkmnBlewAwaySpikes[] = _("{B_ATK_NAME_WITH_PREFIX} befreit\nsich vo SPIKES!");
static const u8 sText_PkmnFledFromBattle[] = _("{B_ATK_NAME_WITH_PREFIX} \nverpisst sich (Skilehrer)!");
static const u8 sText_PkmnForesawAttack[] = _("{B_ATK_NAME_WITH_PREFIX} \nhät de Shit gseh cho!");
static const u8 sText_PkmnTookAttack[] = _("{B_DEF_NAME_WITH_PREFIX} nimmt\nAtacke vo {B_BUFF1}!");
static const u8 sText_PkmnChoseXAsDestiny[] = _("{B_ATK_NAME_WITH_PREFIX} wählt\n{B_CURRENT_MOVE} (geil)!");
static const u8 sText_PkmnAttack[] = _("{B_BUFF1}'s Fuscht-id-Frässi!");
static const u8 sText_PkmnCenterAttention[] = _("{B_ATK_NAME_WITH_PREFIX} find\nsich de Geilscht!");
static const u8 sText_PkmnChargingPower[] = _("{B_ATK_NAME_WITH_PREFIX} \nchillts e Rundi!");
static const u8 sText_NaturePowerTurnedInto[] = _("NATURE POWER wird zu\n{B_CURRENT_MOVE}!");
static const u8 sText_PkmnStatusNormal[] = _("{B_ATK_NAME_WITH_PREFIX}'s Status\nwird Normal!");
static const u8 sText_PkmnSubjectedToTorment[] = _("{B_DEF_NAME_WITH_PREFIX} find\nTORMENT ungeil!");
static const u8 sText_PkmnTighteningFocus[] = _("{B_ATK_NAME_WITH_PREFIX} \ntrinkt en iistee!");
static const u8 sText_PkmnFellForTaunt[] = _("{B_DEF_NAME_WITH_PREFIX} isch\nvoll uf d'Frässi gheit!");
static const u8 sText_PkmnReadyToHelp[] = _("{B_ATK_NAME_WITH_PREFIX} isch parat\nzum {B_DEF_NAME_WITH_PREFIX} helfe!");
static const u8 sText_PkmnSwitchedItems[] = _("{B_ATK_NAME_WITH_PREFIX} tuscht\nZeugs mit em Gegner!");
static const u8 sText_PkmnObtainedX[] = _("{B_ATK_NAME_WITH_PREFIX} bechunt\n{B_BUFF1}.");
static const u8 sText_PkmnObtainedX2[] = _("{B_DEF_NAME_WITH_PREFIX} bechunt\n{B_BUFF2}.");
static const u8 sText_PkmnObtainedXYObtainedZ[] = _("{B_ATK_NAME_WITH_PREFIX} bechunt\n{B_BUFF1}.\p{B_DEF_NAME_WITH_PREFIX} bechunt\n{B_BUFF2}.");
static const u8 sText_PkmnCopiedFoe[] = _("{B_ATK_NAME_WITH_PREFIX} klaut\n{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}!");
static const u8 sText_PkmnMadeWish[] = _("{B_ATK_NAME_WITH_PREFIX} raucht e Ziggi!");
static const u8 sText_PkmnWishCameTrue[] = _("{B_BUFF1}'s wott\nes Poni!");
static const u8 sText_PkmnPlantedRoots[] = _("{B_ATK_NAME_WITH_PREFIX} pflanz Durian!");
static const u8 sText_PkmnAbsorbedNutrients[] = _("{B_ATK_NAME_WITH_PREFIX} isst\nRavioli us de Büchs!");
static const u8 sText_PkmnAnchoredItself[] = _("{B_DEF_NAME_WITH_PREFIX} hockt\nab und pennt!");
static const u8 sText_PkmnWasMadeDrowsy[] = _("{B_ATK_NAME_WITH_PREFIX} stresst\n{B_DEF_NAME_WITH_PREFIX} unnötig!");
static const u8 sText_PkmnKnockedOff[] = _("{B_ATK_NAME_WITH_PREFIX} klaut\n{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}!");
static const u8 sText_PkmnSwappedAbilities[] = _("{B_ATK_NAME_WITH_PREFIX} tuscht ABILITIES\nmit em Gegner!");
static const u8 sText_PkmnSealedOpponentMove[] = _("{B_ATK_NAME_WITH_PREFIX} macht em\nGegner sini Moves kaputt!");
static const u8 sText_PkmnWantsGrudge[] = _("{B_ATK_NAME_WITH_PREFIX} zeigt\nem Gegner de Finger!");
static const u8 sText_PkmnLostPPGrudge[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1} verlüührt\nalli PPs!");
static const u8 sText_PkmnShroudedItself[] = _("{B_ATK_NAME_WITH_PREFIX} umhüllt\nsich in {B_CURRENT_MOVE}!");
static const u8 sText_PkmnMoveBounced[] = _("Mit {B_ATK_NAME_WITH_PREFIX} sim {B_CURRENT_MOVE}\npassiert irgend ein Shit...!");
static const u8 sText_PkmnWaitsForTarget[] = _("{B_ATK_NAME_WITH_PREFIX} warted uf dä\nIdiot gegenüber...!");
static const u8 sText_PkmnSnatchedMove[] = _("{B_DEF_NAME_WITH_PREFIX} klaut\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s Move (krass)!");
static const u8 sText_ElectricityWeakened[] = _("Elektrizität wird schwach\n(naja ...gay)!");
static const u8 sText_FireWeakened[] = _("Fire wird schwach\n(ungeil)!");
static const u8 sText_XFoundOneY[] = _("{B_ATK_NAME_WITH_PREFIX} finded\neis {B_LAST_ITEM}!");
static const u8 sText_SoothingAroma[] = _("Es Aroma gaht ume. Öpper hät\neine gschisse (böös)!");
static const u8 sText_ItemsCantBeUsedNow[] = _("Chasch kei Zeugs benutze jetzt Dude.{PAUSE 64}");
static const u8 sText_ForXCommaYZ[] = _("Für {B_SCR_ACTIVE_NAME_WITH_PREFIX},\n{B_LAST_ITEM} {B_BUFF1}");
static const u8 sText_PkmnUsedXToGetPumped[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} git sich\n{B_LAST_ITEM} zum ufgeile!");
static const u8 sText_PkmnLostFocus[] = _("{B_ATK_NAME_WITH_PREFIX} isch b'hinderet\nund paralüsiert (wie Pfoschte, mann)!");
static const u8 sText_PkmnWasDraggedOut[] = _("{B_DEF_NAME_WITH_PREFIX} wird\nvom Mammi gholt!{PAUSE 32}"); // \p"); was here
static const u8 sText_TheWallShattered[] = _("D'Wand bechunt Fuscht und bricht!");
static const u8 sText_ButNoEffect[] = _("Aber noone cares.. (maybe dä Wayne)!");
static const u8 sText_PkmnHasNoMovesLeft[] = _("{B_ACTIVE_NAME_WITH_PREFIX} het kei\nDroge meh!{PAUSE 32}"); // \p"); was here
static const u8 sText_PkmnMoveIsDisabled[] = _("{B_ACTIVE_NAME_WITH_PREFIX}'s {B_CURRENT_MOVE}\nisch blokkiert ihms!{PAUSE 32}"); // \p"); was here
static const u8 sText_PkmnCantUseMoveTorment[] = _("{B_ACTIVE_NAME_WITH_PREFIX} chan nöd de gliche\nMove benutze (Shit happens)!{PAUSE 32}"); // \p"); was here
static const u8 sText_PkmnCantUseMoveTaunt[] = _("{B_ACTIVE_NAME_WITH_PREFIX} chan nöd\n{B_CURRENT_MOVE} benutze (gay)!{PAUSE 32}"); // \p"); was here
static const u8 sText_PkmnCantUseMoveSealed[] = _("{B_ACTIVE_NAME_WITH_PREFIX} chan nöd\ndä {B_CURRENT_MOVE} benutze!{PAUSE 32}"); // \p"); was here
static const u8 sText_PkmnMadeItRain[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nmacht voll Rägetanz!");
static const u8 sText_PkmnRaisedSpeed[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nmacht grösser de Speed!");
static const u8 sText_PkmnProtectedBy[] = _("{B_DEF_NAME_WITH_PREFIX} wird gschützt\ndurch {B_DEF_ABILITY}!");
static const u8 sText_PkmnPreventsUsage[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nblockiert {B_ATK_NAME_WITH_PREFIX}\lvo {B_CURRENT_MOVE}!");
static const u8 sText_PkmnRestoredHPUsing[] = _("{B_DEF_NAME_WITH_PREFIX} bechunt HP\ndurch {B_DEF_ABILITY}!");
static const u8 sText_PkmnsXMadeYUseless[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\ninmobilisiert {B_CURRENT_MOVE} (geil)!");
static const u8 sText_PkmnChangedTypeWith[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nkonvertiert zu {B_BUFF1}!");
static const u8 sText_PkmnPreventsParalysisWith[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nblockiert B'hinderig (geil)!");
static const u8 sText_PkmnPreventsRomanceWith[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nblockiert Romantik (gay)!");
static const u8 sText_PkmnPreventsPoisoningWith[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nblockiert Spitalbsuech (geil)!");
static const u8 sText_PkmnPreventsConfusionWith[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nblockiert Arztbsuech (geil)!");
static const u8 sText_PkmnRaisedFirePowerWith[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nmacht grösser Füürkraft!");
static const u8 sText_PkmnAnchorsItselfWith[] = _("{B_DEF_NAME_WITH_PREFIX} hockt\nam Bode wäge {B_DEF_ABILITY}!");
static const u8 sText_PkmnCutsAttackWith[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nschnipplet {B_DEF_NAME_WITH_PREFIX}'s ATTACK!");
static const u8 sText_PkmnPreventsStatLossWith[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nblockiert ...öppis!");
static const u8 sText_PkmnHurtsWith[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\ntuet weh {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnTraced[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} verfolgt\n{B_BUFF1}'s {B_BUFF2}!");
static const u8 sText_PkmnsXPreventsBurns[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_EFF_ABILITY}\nblockiert verbrännig!");
static const u8 sText_PkmnsXBlocksY[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nblockiert {B_CURRENT_MOVE}!");
static const u8 sText_PkmnsXBlocksY2[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nblockiert {B_CURRENT_MOVE}!");
static const u8 sText_PkmnsXRestoredHPALittle2[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\nbechunt wieder e kli HP!");
static const u8 sText_PkmnsXWhippedUpSandstorm[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nmacht Sandsturm (geil)!");
static const u8 sText_PkmnsXIntensifiedSun[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nschmiert Sunecreme ih!");
static const u8 sText_PkmnsXPreventsYLoss[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nblockiert {B_BUFF1}-Verluscht!");
static const u8 sText_PkmnsXInfatuatedY[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nmacht {B_ATK_NAME_WITH_PREFIX} geil!");
static const u8 sText_PkmnsXMadeYIneffective[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nmacht {B_CURRENT_MOVE} b'hinderet!");
static const u8 sText_PkmnsXCuredYProblem[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nheilt d'{B_BUFF1}-Problem!");
static const u8 sText_ItSuckedLiquidOoze[] = _("Wird uufgsuugt vo LIQUID OOZE\nwiä en Spaghetti (geil)!");
static const u8 sText_PkmnTransformed[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} transformiert \n(wie Ladyboy)!");
static const u8 sText_PkmnsXTookAttack[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nnimmt Attackeee (krass)!");
const u8 gText_PkmnsXPreventsSwitching[] = _("{B_BUFF1}'s {B_LAST_ABILITY}\nblockiert Veränderig!{PAUSE 32}"); // \p"); was here
static const u8 sText_PreventedFromWorking[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nblockiert {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s\l{B_BUFF1} (veli niceee)!");
static const u8 sText_PkmnsXMadeItIneffective[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nmacht ineffektiv!");
static const u8 sText_PkmnsXPreventsFlinching[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_EFF_ABILITY}\nblockiert B'hinderig!");
static const u8 sText_PkmnsXPreventsYsZ[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\nblockiert {B_DEF_NAME_WITH_PREFIX}'s\l{B_DEF_ABILITY} (veli niceee)!");
static const u8 sText_PkmnsXCuredItsYProblem[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nheilt d'{B_BUFF1}-Problem!");
static const u8 sText_PkmnsXHadNoEffectOnY[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nhät kei Effekt uf {B_EFF_NAME_WITH_PREFIX}!");
static const u8 sText_StatSharply[] = _("böös ");
const u8 gText_StatRose[] = _("isch gstigge!");
static const u8 sText_StatHarshly[] = _("krass ");
static const u8 sText_StatFell[] = _("isch gfalle!");
...
static const u8 sText_UsingItemTheStatOfPkmnRose[] = _("Benutz {B_LAST_ITEM}, dä {B_BUFF1}\nvo {B_SCR_ACTIVE_NAME_WITH_PREFIX} {B_BUFF2}");
...
static const u8 sText_StatsWontIncrease2[] = _("{B_ATK_NAME_WITH_PREFIX}'s Stats gönd\nnöd hööcher!");
static const u8 sText_StatsWontDecrease2[] = _("{B_DEF_NAME_WITH_PREFIX}'s Stats gönd\nnöd tüüüfer!");
static const u8 sText_CriticalHit[] = _("Voll id Frässi!");
static const u8 sText_OneHitKO[] = _("Voll id Frässi!");
static const u8 sText_123Poof[] = _("{PAUSE 32}1, {PAUSE 15}2,&{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Booom!{PAUSE 32}"); // \p"); was here
static const u8 sText_AndEllipsis[] = _("Und…{PAUSE 32}"); // \p"); was here
static const u8 sText_HMMovesCantBeForgotten[] = _("HM Moves chönd nöd \nvergässe werde du B'hinderete.{PAUSE 32}"); // \p"); was here
static const u8 sText_NotVeryEffective[] = _("Nöd effektiv (wie Salami)…");
static const u8 sText_SuperEffective[] = _("Geil effektiv (wie Rakeete)…");
static const u8 sText_GotAwaySafely[] = _("{B_PLAYER_MON1_NAME} het sich verpisst!{PAUSE 32}"); // \p"); was here // _("{PLAY_SE SE_FLEE}Het sich verpisst!{PAUSE 32}"); // \p"); was here
static const u8 sText_PkmnFledUsingIts[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} verpisst\nsich mit {B_LAST_ITEM}!{PAUSE 32}"); // \p"); was here
static const u8 sText_PkmnFledUsing[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} verpisst\nsich mit {B_ATK_ABILITY}!{PAUSE 32}"); // \p"); was here
static const u8 sText_WildPkmnFled[] = _("{PLAY_SE SE_FLEE}{B_BUFF1} haut ap!");
static const u8 sText_PlayerDefeatedLinkTrainer[] = _("{B_LINK_OPPONENT1_NAME} chans nöd take!\nMuss is Spital!");
static const u8 sText_TwoLinkTrainersDefeated[] = _("{B_LINK_OPPONENT1_NAME} und {B_LINK_OPPONENT2_NAME}\nmüend is Spital!");
static const u8 sText_PlayerLostAgainstLinkTrainer[] = _("{B_LINK_OPPONENT1_NAME} triumpfiert\nWas für en Penner!");
static const u8 sText_PlayerLostToTwo[] = _("{B_LINK_OPPONENT1_NAME} und {B_LINK_OPPONENT2_NAME}\ntriumpfieret. Shit happens!");
static const u8 sText_PlayerBattledToDrawLinkTrainer[] = _("Glichstand mit {B_LINK_OPPONENT1_NAME}!");
static const u8 sText_PlayerBattledToDrawVsTwo[] = _("Glichstand mit de Penners\n{B_LINK_OPPONENT1_NAME} & {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_WildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} verpisst sich!");
static const u8 sText_TwoWildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} &\n{B_LINK_OPPONENT2_NAME} verpissed sich!");
static const u8 sText_NoRunningFromTrainers[] = _("Shit! Chan nöd\nvom Skilehrer-Battle abhaue!{PAUSE 32}"); // \p"); was here
static const u8 sText_CantEscape[] = _("Shit! Abhaue unmöglich{PAUSE 32}"); // \p"); was here
static const u8 sText_DontLeaveBirch[] = _("Dr. Pimmel: Hau nöd ab biitee\lIch bruchs Mammi!{PAUSE 32}"); // \p"); was here
static const u8 sText_ButNothingHappened[] = _("Aber nüt isch passiert (wtf)!");
static const u8 sText_ButItFailed[] = _("Aber isch gfailed (gay)!");
static const u8 sText_ItHurtConfusion[] = _("Tut sich selber weh\n…was für en B'hinderete!");
static const u8 sText_MirrorMoveFailed[] = _("The MIRROR MOVE failed!");
static const u8 sText_StartedToRain[] = _("Hät agfange pisse!"); // ... …
static const u8 sText_DownpourStarted[] = _("Hät agfange pisse!"); // corresponds to DownpourText in pokegold& pokecrystal& is used by Rain Dance in GSC
static const u8 sText_RainContinues[] = _("…pisst immer wiiter (wie idä Schwiiz)");
static const u8 sText_DownpourContinues[] = _("???"); // unused
static const u8 sText_RainStopped[] = _("Pisse hört uf (Sunnäcreme time)");
static const u8 sText_SandstormBrewed[] = _("Sandsturm chunt (wie Schoggipulver)!");
static const u8 sText_SandstormRages[] = _("Sandsturm windet (krass)");
static const u8 sText_SandstormSubsided[] = _("Sandsturm verpisst sich");
static const u8 sText_SunlightGotBright[] = _("Sunne strahlt (Sunnebrülle dude)");
static const u8 sText_SunlightStrong[] = _("Voll sunnig, gan id Badi");
static const u8 sText_SunlightFaded[] = _("Wulke chömed (ungeil)");
static const u8 sText_StartedHail[] = _("Fangt a Haglä (gay)");
static const u8 sText_HailContinues[] = _("Haglät wiiter (Shit happens)");
static const u8 sText_HailStopped[] = _("Kei Hagäl meh (nice Time)");
static const u8 sText_FailedToSpitUp[] = _("Aber es gaht id Hose (Shit)!");
static const u8 sText_FailedToSwallow[] = _("Aber es gaht id Hose (Shit)");
static const u8 sText_WindBecameHeatWave[] = _("Usem Wind wird Hizzesturm!");
static const u8 sText_StatChangesGone[] = _("Alli Status Changes \nsind returniert (who cares)!");
static const u8 sText_CoinsScattered[] = _("Kohlä ufem Bode (nice)!");
static const u8 sText_TooWeakForSubstitute[] = _("Isch zuu Skilehrer!");
static const u8 sText_SharedPain[] = _("Es findets alli ungeil!");
static const u8 sText_BellChimed[] = _("S'Mammi rüäft!");
static const u8 sText_FaintInThree[] = _("Alli Pimmel münd nach 3\nTurns is Spital!");
static const u8 sText_NoPPLeft[] = _("Es git kei Kohlä (PP) meh\nfür dä Move!{PAUSE 32}"); // \p"); was here
static const u8 sText_ButNoPPLeft[] = _("Aber es git kei Kohlä (PP) meh\nfür dä Move!");
static const u8 sText_PkmnIgnoresAsleep[] = _("{B_ATK_NAME_WITH_PREFIX} schisst uf Alles!");
static const u8 sText_PkmnIgnoredOrders[] = _("{B_ATK_NAME_WITH_PREFIX} schisst uf Alles!");
static const u8 sText_PkmnBeganToNap[] = _("{B_ATK_NAME_WITH_PREFIX} gaht go penne!");
static const u8 sText_PkmnLoafing[] = _("{B_ATK_NAME_WITH_PREFIX} schisst uf Alles!");
static const u8 sText_PkmnWontObey[] = _("{B_ATK_NAME_WITH_PREFIX} schisst druf!");
static const u8 sText_PkmnTurnedAway[] = _("{B_ATK_NAME_WITH_PREFIX} zeigt de Finger!");
static const u8 sText_PkmnPretendNotNotice[] = _("{B_ATK_NAME_WITH_PREFIX} schisst druf!");
static const u8 sText_EnemyAboutToSwitchPkmn[] = _("{B_TRAINER1_NAME} wott\n{B_BUFF2} benutze.\pWird {B_PLAYER_NAME} dä\nPimmel verändere?");
static const u8 sText_PkmnLearnedMove2[] = _("{B_ATK_NAME_WITH_PREFIX} hät\n{B_BUFF1} glärnt!");
static const u8 sText_PlayerDefeatedLinkTrainerTrainer1[] = _("{B_TRAINER1_NAME} muss is Spital!{PAUSE 32}"); // \p"); was here
static const u8 sText_CreptCloser[] = _("{B_PLAYER_NAME} macht sich a\n{B_OPPONENT_MON1_NAME} ane (gay)!");
static const u8 sText_CantGetCloser[] = _("{B_PLAYER_NAME} chan nöd nöcher ane!");
static const u8 sText_PkmnWatchingCarefully[] = _("{B_OPPONENT_MON1_NAME} luegt gnau!");
static const u8 sText_PkmnCuriousAboutX[] = _("{B_OPPONENT_MON1_NAME} frögt sich härt\nüber dä {B_BUFF1}!");
static const u8 sText_PkmnEnthralledByX[] = _("{B_OPPONENT_MON1_NAME} findet\n{B_BUFF1} geil!");
static const u8 sText_PkmnIgnoredX[] = _("{B_OPPONENT_MON1_NAME} schisst\ncompletely uf {B_BUFF1}!");
static const u8 sText_ThrewPokeblockAtPkmn[] = _("{B_PLAYER_NAME} schmeisst än {POKEBLOCK}\nuf {B_OPPONENT_MON1_NAME}!");
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE SE_DING_DONG}Trottel: Häsch kei\nSAFARI-Eier meh! Verpiss dich!{PAUSE 32}"); // \p"); was here
static const u8 sText_OpponentMon1Appeared[] = _("{B_OPPONENT_MON1_NAME} wott eis id Frässi!{PAUSE 32}"); // \p"); was here
static const u8 sText_WildPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} wott eis id Frässi!{PAUSE 32}"); // \p"); was here
static const u8 sText_LegendaryPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} wott eis id Frässi!{PAUSE 32}"); // \p"); was here
static const u8 sText_WildPkmnAppearedPause[] = _("{B_OPPONENT_MON1_NAME} wott eis id Frässi!{PAUSE 127}");
static const u8 sText_TwoWildPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} &{B_OPPONENT_MON2_NAME} \nbruched eis id Frässi!{PAUSE 32}"); // \p"); was here
static const u8 sText_Trainer1WantsToBattle[] = _("{B_TRAINER1_NAME} wott eis id Frässi!{PAUSE 32}"); // \p"); was here
static const u8 sText_LinkTrainerWantsToBattle[] = _("{B_LINK_OPPONENT1_NAME} wott eis id Frässi!");
static const u8 sText_TwoLinkTrainersWantToBattle[] = _("{B_LINK_OPPONENT1_NAME} & {B_LINK_OPPONENT2_NAME}\nwänd eis id Frässi!");
static const u8 sText_Trainer1SentOutPkmn[] = _("{B_TRAINER1_NAME}'s {B_OPPONENT_MON1_NAME} \nwott eis id Frässi!");
static const u8 sText_Trainer1SentOutTwoPkmn[] = _("{B_TRAINER1_NAME}'s {B_OPPONENT_MON1_NAME} &\n{B_OPPONENT_MON2_NAME} bruched eis id Frässi!");
static const u8 sText_Trainer1SentOutPkmn2[] = _("{B_TRAINER1_NAME}'s {B_BUFF1} wott eis id Frässi!");
static const u8 sText_LinkTrainerSentOutPkmn[] = _("{B_LINK_OPPONENT1_NAME}'s {B_OPPONENT_MON1_NAME}\nwott eis id Frässi!");
...
static const u8 sText_LinkTrainerSentOutPkmn2[] = _("{B_LINK_OPPONENT1_NAME}'s {B_BUFF1}\nwott eis id Frässi!");
static const u8 sText_LinkTrainerMultiSentOutPkmn[] = _("{B_LINK_SCR_TRAINER_NAME}'s {B_BUFF1}\nwott eis id Frässi!");
static const u8 sText_GoPkmn[] = _("Los {B_PLAYER_MON1_NAME}, Schlegglä!");
static const u8 sText_GoTwoPkmn[] = _("Ab is Spital! \nLos, {B_PLAYER_MON1_NAME} + {B_PLAYER_MON2_NAME}, Schlegglä!");
static const u8 sText_GoPkmn2[] = _("Los {B_BUFF1}, Schlegglä!");
static const u8 sText_DoItPkmn[] = _("Id Frässi, los {B_BUFF1}!");
static const u8 sText_GoForItPkmn[] = _("Machs halt, Kakk-{B_BUFF1}!");
static const u8 sText_YourFoesWeakGetEmPkmn[] = _("De Gegner isch e Pfluutä!\nHau en abe, {B_BUFF1}!");
static const u8 sText_LinkPartnerSentOutPkmnGoPkmn[] = _("{B_LINK_PARTNER_NAME} schickt {B_LINK_PLAYER_MON2_NAME}!\nLos {B_LINK_PLAYER_MON1_NAME}, Schlegglä!");
static const u8 sText_PkmnThatsEnough[] = _("{B_BUFF1}, chum zrugg!\nWas für e Pfluutä!");
static const u8 sText_PkmnComeBack[] = _("{B_BUFF1}, chum zrugg du Pfeife!");
static const u8 sText_PkmnOkComeBack[] = _("{B_BUFF1}, Chills!\nChum zrugg du Pfeife!");
static const u8 sText_PkmnGoodComeBack[] = _("{B_BUFF1}, Chills!\nchumg zrugg du Pfeife!");
static const u8 sText_Trainer1WithdrewPkmn[] = _(" {B_TRAINER1_NAME}\nnimmt {B_BUFF1} zrugg!");
static const u8 sText_LinkTrainer1WithdrewPkmn[] = _("{B_LINK_OPPONENT1_NAME} nimmt\n{B_BUFF1} zrugg!");
static const u8 sText_LinkTrainer2WithdrewPkmn[] = _("{B_LINK_SCR_TRAINER_NAME} nimmt\n{B_BUFF1} zrugg!");
static const u8 sText_WildPkmnPrefix[] = _("");
static const u8 sText_FoePkmnPrefix[] = _("Penner ");
static const u8 sText_EmptyString8[] = _("");
static const u8 sText_FoePkmnPrefix2[] = _("Penner");
static const u8 sText_AllyPkmnPrefix[] = _("Kumpel");
static const u8 sText_FoePkmnPrefix3[] = _("Penner");
static const u8 sText_AllyPkmnPrefix2[] = _("Kumpel");
static const u8 sText_FoePkmnPrefix4[] = _("Penner");
static const u8 sText_AllyPkmnPrefix3[] = _("Kumpel");
static const u8 sText_AttackerUsedX[] = _("{B_ATK_NAME_WITH_PREFIX} -\n{B_BUFF2}"); //_("{B_ATK_NAME_WITH_PREFIX} used\n{B_BUFF2}");
static const u8 sText_ExclamationMark[] = _("!");
static const u8 sText_ExclamationMark2[] = _("!");
static const u8 sText_ExclamationMark3[] = _("!");
static const u8 sText_ExclamationMark4[] = _("!");
static const u8 sText_ExclamationMark5[] = _("!");
static const u8 sText_HP2[] = _("Life"); // HP
...
static const u8 sText_PokeblockWasTooSpicy[] = _("was zuu spicy!");
static const u8 sText_PokeblockWasTooDry[] = _("was zuu dry!");
static const u8 sText_PokeblockWasTooSweet[] = _("was zuu sweet!");
static const u8 sText_PokeblockWasTooBitter[] = _("was zuu bitter!");
static const u8 sText_PokeblockWasTooSour[] = _("was zuu sour!");
...
static const u8 sText_PlayerUsedItem[] = _("{B_PLAYER_NAME} git sich\n{B_LAST_ITEM}!");
static const u8 sText_WallyUsedItem[] = _("WALLY used\n{B_LAST_ITEM}!");
static const u8 sText_Trainer1UsedItem[] = _("{B_TRAINER1_NAME}\ngit sich {B_LAST_ITEM}!");
static const u8 sText_TrainerBlockedBall[] = _("The Skilehrer blocked the BALL!");
static const u8 sText_DontBeAThief[] = _("Don't be a thief!");
static const u8 sText_ItDodgedBall[] = _("It dodged the thrown BALL!\nThis Pimmel can't be caught!");
static const u8 sText_YouMissedPkmn[] = _("You missed the Pimmel!");
static const u8 sText_PkmnBrokeFree[] = _("Shit, no!\nThe Pimmel broke free!");
static const u8 sText_ItAppearedCaught[] = _("Aww!\nIt appeared to be caught!");
static const u8 sText_AarghAlmostHadIt[] = _("Aargh!\nAlmost had it!");
static const u8 sText_ShootSoClose[] = _("Shoot!\nIt was so close, too!");
static const u8 sText_GotchaPkmnCaughtPlayer[] = _("Gotcha!\n{B_OPPONENT_MON1_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}{PAUSE 32}"); // \p"); was here
...
static const u8 sText_PkmnSentToPC[] = _("{B_OPPONENT_MON1_NAME} was sent to\n{B_PC_CREATOR_NAME} MAC.");
static const u8 sText_Someones[] = _("someone's");
static const u8 sText_Lanettes[] = _("LANETTE's");
static const u8 sText_PkmnDataAddedToDex[] = _("{B_OPPONENT_MON1_NAME}'s data was\nadded to the Pimmel-Lexikon.{PAUSE 32}"); // \p"); was here
static const u8 sText_ItIsRaining[] = _("Es pisst.");
static const u8 sText_SandstormIsRaging[] = _("A sandstorm is raging.");
static const u8 sText_BoxIsFull[] = _("The BOX is full!\nYou can't catch any more!{PAUSE 32}"); // \p"); was here
static const u8 sText_EnigmaBerry[] = _("ENIGMA Beeri");
static const u8 sText_BerrySuffix[] = _(" Beeri");
...
const u8 gText_PkmnIsEvolving[] = _("Wtf Dude!?\n{STR_VAR_1} is evolving!");
const u8 gText_CongratsPkmnEvolved[] = _("Congratulations! Your {STR_VAR_1}\nevolved into {STR_VAR_2}!{WAIT_SE}{PAUSE 32}"); // \p"); was here
const u8 gText_PkmnStoppedEvolving[] = _("Shit!? {STR_VAR_1}\nstopped evolving!{PAUSE 32}"); // \p"); was here
const u8 gText_EllipsisQuestionMark[] = _("……?{PAUSE 32}"); // \p"); was here
const u8 gText_WhatWillPkmnDo[] = _("{B_ACTIVE_NAME_WITH_PREFIX}?"); //_("What will\n{B_ACTIVE_NAME_WITH_PREFIX} do?");
const u8 gText_WhatWillPkmnDo2[] = _("{B_PLAYER_NAME}?");
const u8 gText_WhatWillWallyDo[] = _("What will\nPimmeltrainer do?");
const u8 gText_LinkStandby[] = _("{PAUSE 16}Link standby…");
const u8 gText_BattleMenu[] = _("Move{CLEAR_TO 56}Tüüte\nPimmel{CLEAR_TO 56}-"); // messages in fight box _("FIGHT{CLEAR_TO 56}BAG\nPimmel{CLEAR_TO 56}RUN"); // messages in fight box
const u8 gText_SafariZoneMenu[] = _("Eii{CLEAR_TO 56}{POKEBLOCK}\nGO NEAR{CLEAR_TO 56}RUN");
const u8 gText_MoveInterfacePP[] = _("pp ");
const u8 gText_MoveInterfaceType[] = _(" - ");
const u8 gText_MoveInterfacePpType[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}  \n  ");
const u8 gText_MoveInterfaceDynamicColors[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}");
const u8 gText_WhichMoveToForget4[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Welle Move söll\nvergässe werde?");
const u8 gText_BattleYesNoChoice[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Jaa\nNeii");
...
static const u8 sText_HP[] = _("Life"); //HP
...
const u8 gText_SafariBalls[] = _("{HIGHLIGHT DARK_GRAY}SAFARI-Eier");
const u8 gText_SafariBallLeft[] = _("{HIGHLIGHT DARK_GRAY}Left: $" "{HIGHLIGHT DARK_GRAY}");
const u8 gText_Sleep[] = _("pennä");
const u8 gText_Poison[] = _("gift");
const u8 gText_Burn[] = _("verbränn");
const u8 gText_Paralysis[] = _("b'hinderet");
const u8 gText_Ice[] = _("iis");
const u8 gText_Confusion[] = _("verwirrt");
const u8 gText_Love[] = _("liebi");
...
const u8 gText_BadEgg[] = _("Shit-Ei");
const u8 gText_BattleWallyName[] = _("Walli");
...
static const u8 sATypeMove_Table[NUMBER_OF_MON_TYPES][17] =
{
    ...
    [TYPE_FIGHTING] = _("a Kampf move"),
    [TYPE_FLYING]   = _("a Flug move"),
    [TYPE_POISON]   = _("a Gift move"),
    [TYPE_GROUND]   = _("a Bodä move"),
    [TYPE_ROCK]     = _("a Stei move"),
    [TYPE_BUG]      = _("a Käfer move"),
    [TYPE_GHOST]    = _("a Geisht move"),
    [TYPE_STEEL]    = _("a Stahl move"),
    [TYPE_MYSTERY]  = _("a ??? move"),
    [TYPE_FIRE]     = _("a Füür move"),
    [TYPE_WATER]    = _("a Wasser move"),
    [TYPE_GRASS]    = _("a Graas move"),
    [TYPE_ELECTRIC] = _("an Elektro move"),
    [TYPE_PSYCHIC]  = _("a Psücho move"),
    [TYPE_ICE]      = _("an iis move"),
    [TYPE_DRAGON]   = _("a Drachä move"),
    [TYPE_DARK]     = _("a Dunkel move")
};

const u8 gText_BattleTourney[] = _("Kampf TOURNEY");
...
const u8 gText_TheGreatNewHope[] = _("The great new hope!{PAUSE 32}"); // \p"); was here
const u8 gText_WillChampionshipDreamComeTrue[] = _("Will the championship dream come true?!{PAUSE 32}"); // \p"); was here
const u8 gText_AFormerChampion[] = _("A former Pimmeltrainer!{PAUSE 32}"); // \p"); was here
const u8 gText_ThePreviousChampion[] = _("The previous Pimmeltrainer!{PAUSE 32}"); // \p"); was here
const u8 gText_TheUnbeatenChampion[] = _("The unbeaten Pimmeltrainer!{PAUSE 32}"); // \p"); was here
...
static const u8 sText_TwoTrainersSentPkmn[] = _("{B_TRAINER1_NAME}'s {B_OPPONENT_MON1_NAME}\nwott eis id Frässi!\p{B_TRAINER2_NAME}'s {B_OPPONENT_MON2_NAME}\nwott eis id Frässi!");
static const u8 sText_Trainer2SentOutPkmn[] = _("{B_TRAINER2_NAME}'s {B_BUFF1}\nwott eis id Frässi!");
static const u8 sText_TwoTrainersWantToBattle[] = _("{B_TRAINER1_NAME} + {B_TRAINER2_NAME}\nwänd d'Frässi poliert!{PAUSE 32}"); // \p"); was here
static const u8 sText_InGamePartnerSentOutZGoN[] = _("{B_PARTNER_NAME}'s {B_PLAYER_MON2_NAME}\nwott eis id Frässi!\lLos {B_PLAYER_MON1_NAME}, Schlegglä!");
static const u8 sText_TwoInGameTrainersDefeated[] = _("{B_TRAINER1_NAME} + {B_TRAINER2_NAME}\ngönd is Spital!{PAUSE 32}"); // \p"); was here
...
static const u8 sText_RefIfNothingIsDecided[] = _("Schiiri: If nothing is decided in\n3 turns, we will go to judging!");
static const u8 sText_RefThatsIt[] = _("Schiiri: That's it! We will now go to\njudging to determine the winner!");
static const u8 sText_RefJudgeMind[] = _("Schiiri: Judging category 1, Mind!\nThe Pimmel showing the most guts!{PAUSE 32}"); // \p"); was here
static const u8 sText_RefJudgeSkill[] = _("Schiiri: Judging category 2, Skill!\nThe Pimmel using moves the best!{PAUSE 32}"); // \p"); was here
static const u8 sText_RefJudgeBody[] = _("Schiiri: Judging category 3, Body!\nThe Pimmel with the most vitality!{PAUSE 32}"); // \p"); was here
static const u8 sText_RefPlayerWon[] = _("Schiiri: Judgment: {B_BUFF1} to {B_BUFF2}!\nThe winner is {B_PLAYER_NAME}'s {B_PLAYER_MON1_NAME}!{PAUSE 32}"); // \p"); was here
static const u8 sText_RefOpponentWon[] = _("Schiiri: Judgment: {B_BUFF1} to {B_BUFF2}!\nThe winner is {B_TRAINER1_NAME}'s {B_OPPONENT_MON1_NAME}!{PAUSE 32}"); // \p"); was here
static const u8 sText_RefDraw[] = _("Schiiri: Judgment: 3 to 3!\nWe have a draw!{PAUSE 32}"); // \p"); was here
static const u8 sText_DefeatedOpponentByReferee[] = _("{B_PLAYER_MON1_NAME} defeated the opponent\n{B_OPPONENT_MON1_NAME} in a Schiiri's decision!");
...
static const u8 sText_RefCommenceBattle[] = _("Schiiri: {B_PLAYER_MON1_NAME} VS {B_OPPONENT_MON1_NAME}!\nCommence battling!");
...
static const u8 sText_Trainer1Fled[] = _( "{PLAY_SE SE_FLEE} {B_TRAINER1_NAME} het \lsich verpisst!");
static const u8 sText_PlayerLostAgainstTrainer1[] = _("Penner lost against\n{B_TRAINER1_NAME}!");
static const u8 sText_PlayerBattledToDrawTrainer1[] = _("Penner battled to a draw against\n{B_TRAINER1_NAME}!");
const u8 gText_RecordBattleToPass[] = _("Would you like to record your battle\non your FRONTIER PASS?");
const u8 gText_BattleRecordedOnPass[] = _("{B_PLAYER_NAME}'s battle result was recorded\non the FRONTIER PASS.");
static const u8 sText_LinkTrainerWantsToBattlePause[] = _("{B_LINK_OPPONENT1_NAME}\nwott eis id Frässi!{PAUSE 49}");
static const u8 sText_TwoLinkTrainersWantToBattlePause[] = _("{B_LINK_OPPONENT1_NAME} & {B_LINK_OPPONENT2_NAME}\nwänd eis id Frässi!{PAUSE 49}");
...
// into the table of moves at sGrammarMoveUsedTable& varied the line accordingly.
//
...
// names were verbs, such as Recover,& resulted in translations like "<NAME>
// recovered itself!".
//
