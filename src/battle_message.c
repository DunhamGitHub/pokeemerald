...
static const u8 sText_DidNotLearnMove[] = _("{B_BUFF1} hät {B_BUFF2} nöd glernt."); // \p"); was here
...
static const u8 sText_AttackerFainted[] = _("{B_ATK_NAME_WITH_PREFIX}\nchans nöd take!"); // \p"); was here // _("{B_ATK_NAME_WITH_PREFIX}\nfainted!"); // \p"); was here
static const u8 sText_TargetFainted[] = _("{B_DEF_NAME_WITH_PREFIX}\nchans nöd take!"); // \p"); was here
static const u8 sText_PlayerGotMoney[] = _("{B_PLAYER_NAME} bechunt ¥{B_BUFF1} zum Sieg!"); // \p"); was here
static const u8 sText_PlayerWhiteout[] = _("{B_PLAYER_NAME} het kei\nPimmel meh!"); // \p"); was here
static const u8 sText_PlayerWhiteout2[] = _("{B_PLAYER_NAME} muss is Spital!"); // {PAUSE_UNTIL_PRESS}");
static const u8 sText_PreventsEscape[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} prevents\nescape with {B_SCR_ACTIVE_ABILITY}!"); // \p"); was here
static const u8 sText_CantEscape2[] = _("Verpisse isch unpossible!"); // \p"); was here
...
static const u8 sText_PlayerPickedUpMoney[] = _("{B_PLAYER_NAME} nimmt ¥{B_BUFF1}!"); // \p"); was here
...
const u8 gText_PkmnsXPreventsSwitching[] = _("{B_BUFF1}'s {B_LAST_ABILITY}\nblockiert Veränderig!"); // \p"); was here
...
static const u8 sText_123Poof[] = _("{PAUSE 32}1, {PAUSE 15}2,&{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Booom!"); // \p"); was here
static const u8 sText_AndEllipsis[] = _("Und…"); // \p"); was here
static const u8 sText_HMMovesCantBeForgotten[] = _("HM Moves chönd nöd \nvergässe werde du B'hinderete."); // \p"); was here
...
static const u8 sText_GotAwaySafely[] = _("{B_PLAYER_MON1_NAME} het sich verpisst!"); // \p"); was here // _("{PLAY_SE SE_FLEE}Het sich verpisst!"); // \p"); was here
static const u8 sText_PkmnFledUsingIts[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} verpisst\nsich mit {B_LAST_ITEM}!"); // \p"); was here
static const u8 sText_PkmnFledUsing[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} verpisst\nsich mit {B_ATK_ABILITY}!"); // \p"); was here
static const u8 sText_WildPkmnFled[] = _("{PLAY_SE SE_FLEE}Freis {B_BUFF1} haut ap!");
...
static const u8 sText_NoRunningFromTrainers[] = _("Shit! Chan nöd\nvom Skilehrer-Battle abhaue!"); // \p"); was here
static const u8 sText_CantEscape[] = _("Shit! Abhaue unmöglich"); // \p"); was here
static const u8 sText_DontLeaveBirch[] = _("Dr. Pimmel: Hau nöd ab biitee\lIch bruchs Mammi!"); // \p"); was here
...
static const u8 sText_PlayerDefeatedLinkTrainerTrainer1[] = _("{B_TRAINER1_NAME} muss is Spital!"); // \p"); was here
...
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE SE_DING_DONG}Trottel: Häsch kei\nSAFARI-Eier meh! Verpiss dich!"); // \p"); was here
static const u8 sText_OpponentMon1Appeared[] = _("{B_OPPONENT_MON1_NAME} wott eis id Frässi!"); // \p"); was here
static const u8 sText_WildPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} wott eis id Frässi!"); // \p"); was here
static const u8 sText_LegendaryPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} wott eis id Frässi!"); // \p"); was here
static const u8 sText_WildPkmnAppearedPause[] = _("{B_OPPONENT_MON1_NAME} wott eis id Frässi!{PAUSE 127}");
static const u8 sText_TwoWildPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} &{B_OPPONENT_MON2_NAME} \nbruched eis id Frässi!"); // \p"); was here
static const u8 sText_Trainer1WantsToBattle[] = _("{B_TRAINER1_NAME} wott eis id Frässi!"); // \p"); was here
...
static const u8 sText_WildPkmnPrefix[] = _("Freis ");
...
static const u8 sText_GotchaPkmnCaughtPlayer[] = _("Gotcha!\n{B_OPPONENT_MON1_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}"); // \p"); was here
...
const u8 gText_CongratsPkmnEvolved[] = _("Congratulations! Your {STR_VAR_1}\nevolved into {STR_VAR_2}!{WAIT_SE}"); // \p"); was here
const u8 gText_PkmnStoppedEvolving[] = _("Shit!? {STR_VAR_1}\nstopped evolving!"); // \p"); was here
const u8 gText_EllipsisQuestionMark[] = _("……?"); // \p"); was here
...
const u8 gText_TheGreatNewHope[] = _("The great new hope!"); // \p"); was here
const u8 gText_WillChampionshipDreamComeTrue[] = _("Will the championship dream come true?!"); // \p"); was here
const u8 gText_AFormerChampion[] = _("A former Pimmeltrainer!"); // \p"); was here
const u8 gText_ThePreviousChampion[] = _("The previous Pimmeltrainer!"); // \p"); was here
const u8 gText_TheUnbeatenChampion[] = _("The unbeaten Pimmeltrainer!"); // \p"); was here
